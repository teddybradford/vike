...
`,e.jsxs(t.p,{children:["If you don't use a ",e.jsx(a,{}),", then we recommend to use Server Routing by default as it leads to a simpler architecture."]}),`
