import{j as e,o as s,i as t}from"../chunks/chunk-QQHFLgus.js";import{L as r}from"../chunks/chunk-DJTIoNMK.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-7E_FEcaS.js";/* empty css                      */const d=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Disable the automatic chaining of build steps."}),`
...
`,e.jsxs(n.li,{children:["Pre-rendering (if ",e.jsx(r,{text:"pre-rendering is enabled",href:"/pre-rendering"}),")."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:["Run the pre-rendering programmatically, see ",e.jsx(r,{href:"/prerender-programmatic"}),"."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["If your goal is only to ",e.jsx(r,{href:"/prerender-programmatic",children:"programmatically run pre-rendering"})," then consider using ",e.jsx(r,{href:"/prerender#disableautorun",children:e.jsx("code",{children:"prerender.disableAutoRun"})})," instead."]}),`
`]}),`
`,e.jsx("h2",{id:"see-also",children:"See also"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(r,{href:"/prerender-programmatic"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
