import{j as e,b as a,o as r,i}from"../chunks/chunk-B1niCXMT.js";import{L as n}from"../chunks/chunk-CFDfndwJ.js";/* empty css                      */import{W as o}from"../chunks/chunk-DNcm9zqy.js";import{V as d}from"../chunks/chunk-DHVYgKJd.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B0HWZO65.js";/* empty css                      */const c=[{pageSectionId:"vue",pageSectionLevel:2,pageSectionTitle:"Vue"},{pageSectionId:"react",pageSectionLevel:2,pageSectionTitle:"React"},{pageSectionId:"metadata",pageSectionLevel:2,pageSectionTitle:"Metadata"},{pageSectionId:"local-metadata",pageSectionLevel:4,pageSectionTitle:"Local metadata"},{pageSectionId:"global-metadata",pageSectionLevel:4,pageSectionTitle:"Global metadata"},{pageSectionId:"with-a-metadata-js-file",pageSectionLevel:3,pageSectionTitle:"With a `metadata.js` file"},{pageSectionId:"with-custom-settings",pageSectionLevel:3,pageSectionTitle:"With custom settings"},{pageSectionId:"with-frontmatter",pageSectionLevel:3,pageSectionTitle:"With frontmatter"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(l){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx("h2",{id:"vue",children:"Vue"}),`
...
`]}),`
`]}),`
`,e.jsx(o,{children:e.jsxs(s.p,{children:["You may be tempted to use ",e.jsx(s.a,{href:"https://vitejs.dev/guide/features.html#glob-import",children:e.jsx(s.code,{children:"import.meta.glob()"})})," to retrieve the metadata of all your pages, but we discourage this approach: loading all markdown files at once ",e.jsx(d,{}),"."]})}),`
`,e.jsxs("h3",{id:"with-a-metadata-js-file",children:["With a ",e.jsx("code",{children:"metadata.js"})," file"]}),`
`,e.jsxs(s.p,{children:["A simple way to define metadata is to define a ",e.jsx(s.code,{children:"metadata.js"})," file that contains ",e.jsx(n,{href:"#metadata:~:text=global%20or%20local.-,Global%20metadata,-.",children:"global metadata"}),"."]}),`
...
`,e.jsxs(s.p,{children:["You can use ",e.jsx(n,{href:"/meta",children:e.jsx(s.code,{children:"meta"})})," to create custom settings for defining ",e.jsx(n,{href:"#metadata:~:text=for%20every%20page.-,Local%20metadata,-.",children:"local metadata"}),"."]}),`
