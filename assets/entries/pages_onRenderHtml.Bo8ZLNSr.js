import{j as e,L as t,o,i}from"../chunks/chunk-DM7AsBj_.js";import{L as l}from"../chunks/chunk-Bj_tsSMy.js";/* empty css                      */import{U as r}from"../chunks/chunk-aPPE7DXi.js";import{H as d}from"../chunks/chunk-C2w9vwOJ.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-Be-9ij3x.js";/* empty css                      */const c=[{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(s){const n={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Environment: server."}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onRenderHtml()"})," hook defines how pages are rendered to HTML."]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onRenderHtml()"})," and ",e.jsx(l,{href:"/onRenderClient",children:e.jsx(n.code,{children:"onRenderClient()"})})," hooks are essentially the glue code between Vike and the UI framework (React/Vue/Solid/...)."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["If you use a ",e.jsx(r,{}),", then you don't need to define ",e.jsx(n.code,{children:"onRenderHtml()"})," as it's already defined by ",e.jsx(r,{name:!0,noLink:!0}),"."]}),`
`]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"  }"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(n.p,{children:["Where ",e.jsx(n.code,{children:"pageContext.Page"})," is the ",e.jsx(n.code,{children:"Page"})," value of the page that is being rendered, see ",e.jsx(l,{href:"/Page"}),"."]}),`
...
`,e.jsx(l,{href:"/onAfterRenderHtml"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
