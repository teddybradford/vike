import{j as e,L as a,o,i as t}from"../chunks/chunk-Dy-7d58W.js";import{L as n}from"../chunks/chunk-CjJyfV2B.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DWElet6Q.js";/* empty css                      */const i=[{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"first-step",pageSectionLevel:3,pageSectionTitle:"First step"},{pageSectionId:"progressively-create-your-framework",pageSectionLevel:3,pageSectionTitle:"Progressively create your framework"}];function l(r){const s={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Vike enables you to create your own framework tailored to your company's requirements."}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["It's a powerful way to scale your teams, and to ensure a cohesive stack throughout your company. See ",e.jsx(n,{href:"/why#build-your-own-framework"}),"."]}),`
`]}),`
...
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/meta",children:"Create custom settings"}),", so that your Product Developers can easily configure your framework.",`
