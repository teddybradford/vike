...
`,e.jsxs(n.p,{children:["In general, ",e.jsxs(s,{href:"/server",children:["we recommend using ",e.jsx(n.code,{children:"vike-server"})]})," for automatically integrating Vike with your JavaScript server (Express.js, Hono, Fastify, ...). But you can manually integrate Vike into your server instead if you prefer."]}),`
`,e.jsx(c,{}),`
