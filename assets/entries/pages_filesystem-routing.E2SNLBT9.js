import{j as e,L as o,o as t,i as l}from"../chunks/chunk-B2Nsy3Ql.js";import{L as s}from"../chunks/chunk-raIxkx1Y.js";/* empty css                      */import{W as a}from"../chunks/chunk-DvyJGiE9.js";/* empty css                      */import{U as d}from"../chunks/chunk-Blu7WSIj.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      *//* empty css                      */const c=[{pageSectionId:"ignored-directories",pageSectionLevel:2,pageSectionTitle:"Ignored directories"},{pageSectionId:"case-sensitive",pageSectionLevel:2,pageSectionTitle:"Case sensitive"},{pageSectionId:"crawl-space",pageSectionLevel:2,pageSectionTitle:"Crawl space"},{pageSectionId:"renderer",pageSectionLevel:2,pageSectionTitle:"`renderer/`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(i){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Detailed information about Vike's Filesystem Routing."}),`
`,e.jsxs(n.p,{children:["For an overview, see instead: ",e.jsx(s,{href:"/routing#filesystem-routing",doNotInferSectionTitle:!0}),"."]}),`
...
`})}),`
`,e.jsxs(n.p,{children:["This enables you to set up a ",e.jsx(s,{href:"#domain-driven",children:"domain-driven file structure"}),"."]}),`
`,e.jsxs(n.p,{children:["Instead of ",e.jsx(n.code,{children:"(someDir)"})," you can also use the ",e.jsxs(s,{href:"/filesystemRoutingRoot",children:[e.jsx(n.code,{children:"filesystemRoutingRoot"})," setting"]}),"."]}),`
...
`,e.jsxs(n.p,{children:["Vike crawls files inside ",e.jsxs(n.a,{href:"https://vitejs.dev/config/shared-options.html#root",children:["Vite's ",e.jsx(n.code,{children:"root"})," directory"]}),". Consequently, all your ",e.jsxs(s,{href:"/config#files",children:[e.jsx(n.code,{children:"+"})," files"]})," need to live inside ",e.jsx(n.code,{children:"root"}),"."]}),`
...
`,e.jsx(s,{href:"/routing#filesystem-routing"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
