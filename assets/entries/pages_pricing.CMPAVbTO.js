import{j as e,a as t,L as k,o as S,i as v}from"../chunks/chunk-B4V7wIR1.js";import{L as l}from"../chunks/chunk-DWcoZmvA.js";/* empty css                      */import{a as T}from"../chunks/chunk-DFIQUb2j.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BdLdLbhk.js";import{O as P}from"../chunks/chunk-DSGPjcOd.js";/* empty css                      *//* empty css                      *//* empty css                      */const m="#a00",g="#0a0",C="#e90";function h(){return e.jsx(e.Fragment,{children:" |"})}function O(){return e.jsx("span",{style:{color:g,fontSize:"1.9em",display:"block"},children:"✓"})}function F(){return e.jsx("span",{style:{color:m,fontSize:"1.6em",display:"block"},children:"✗"})}function V({value:s}){const p=x(),i=z(s);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:p,backgroundColor:i,borderRadius:10}})});function x(){return t(s>0&&s<100),"calc("+s/100+" * 100%)"}}function z(s){return t(s>0&&s<100),s<50?m:s>=75?g:C}function u({name:s,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:s}),": ",n]})}function I({entries:s,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(i,{children:""}),e.jsx(i,{children:"Trans­parent"}),e.jsx(i,{children:"Fork­able"}),e.jsx(i,{children:"Access­ible"}),e.jsx(i,{children:"Sustai­nable"}),e.jsx(i,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:s.map((r,a)=>e.jsx(p,{...r},a))})]})});function p({modelName:r,transparent:a,forkable:d,accessible:j,independent:b,sustainable:w}){return e.jsxs("tr",{children:[e.jsx(o,{children:r}),e.jsx(o,{children:e.jsx(c,{val:a})}),e.jsx(o,{children:e.jsx(c,{val:d})}),e.jsx(o,{children:e.jsx(c,{val:j})}),e.jsx(o,{children:e.jsx(c,{val:w})}),e.jsx(o,{children:e.jsx(c,{val:b})})]})}function i({children:r,...a}){if(t(Object.keys(a).length===0),!r)return e.jsx("th",{});const d=r,j=n?d:e.jsx("a",{href:x(d),children:d});return e.jsx("th",{align:"center",children:j})}function x(r){return t(r.constructor===String),t(!r.includes("&shy;"),{value_name:r}),t(!r.includes("%C2%AD"),{value_name:r}),"/values"}function o({children:r}){return e.jsx("td",{align:"center",children:r})}function c({val:r}){return t(0<=r&&r<=1),r===1?e.jsx(O,{}):r===0?e.jsx(F,{}):e.jsx(V,{value:r*100})}}function L(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function f(s){const n={li:"li",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(I,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
...
`]}),`
`]})]})}function D(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(f,{...s})}):f(s)}const N=[{pageSectionId:"how-does-it-work",pageSectionLevel:3,pageSectionTitle:"How does it work?"},{pageSectionId:"do-sponsors-have-to-pay",pageSectionLevel:3,pageSectionTitle:"Do sponsors have to pay?"},{pageSectionId:"why-zero-investors",pageSectionLevel:3,pageSectionTitle:"Why zero investors?"},{pageSectionId:"is-vike-still-free-software",pageSectionLevel:3,pageSectionTitle:"Is Vike still Free Software?"},{pageSectionId:"why-not-another-business-model",pageSectionLevel:3,pageSectionTitle:"Why not another business model?"}];function y(s){const n={a:"a",code:"code",em:"em",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(T,{children:"The Open Source Pricing isn't implemented yet."}),`
