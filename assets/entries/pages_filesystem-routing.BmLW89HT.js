import{j as e,L as r,o,i as a}from"../chunks/chunk-B2Nsy3Ql.js";import{L as i}from"../chunks/chunk-raIxkx1Y.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */const l=[{pageSectionId:"parameterized-routes",pageSectionLevel:2,pageSectionTitle:"Parameterized routes"},{pageSectionId:"case-sensitive",pageSectionLevel:2,pageSectionTitle:"Case sensitive"},{pageSectionId:"ignored-directories",pageSectionLevel:2,pageSectionTitle:"Ignored directories"},{pageSectionId:"crawl",pageSectionLevel:2,pageSectionTitle:"Crawl"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(n){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Vike supports ",e.jsx(s.em,{children:"Filesystem Routing"}),": the URL of a page is determined by where the page is located on your filesystem."]}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"+"})," files are explained at ",e.jsx(i,{href:"/config#files",doNotInferSectionTitle:!0}),"."]}),`
`]}),`
...
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["The parameter ",e.jsx(s.code,{children:"id"})," is available at ",e.jsx(i,{href:"/pageContext",children:e.jsx(s.code,{children:"pageContext.routeParams.id"})}),"."]}),`
`]}),`
...
`})}),`
`,e.jsxs(s.p,{children:["This enables you to set up a domain-driven file structure: ",e.jsx(i,{href:"/file-structure#domain-driven"}),"."]}),`
`,e.jsxs(s.p,{children:["Instead of ",e.jsx(s.code,{children:"(someDir)"})," you can also use the ",e.jsxs(i,{href:"/filesystemRoutingRoot",children:[e.jsx(s.code,{children:"filesystemRoutingRoot"})," setting"]}),"."]}),`
`,e.jsx("h2",{id:"crawl",children:"Crawl"}),`
`,e.jsxs(s.p,{children:["Vike crawls files inside ",e.jsxs(s.a,{href:"https://vitejs.dev/config/shared-options.html#root",children:["Vite's ",e.jsx(s.code,{children:"root"})," directory"]}),". Consequently, all your ",e.jsxs(i,{href:"/config#files",children:[e.jsx(s.code,{children:"+"})," files"]})," need to live inside ",e.jsx(s.code,{children:"root"}),"."]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsx(i,{href:"/config#files",doNotInferSectionTitle:!0}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(i,{href:"/routing"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
