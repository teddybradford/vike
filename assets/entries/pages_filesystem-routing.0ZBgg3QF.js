import{j as e,L as o,o as t,i as l}from"../chunks/chunk-zeMx4K80.js";import{L as s}from"../chunks/chunk-Dzqsd_XM.js";/* empty css                      */import{W as a}from"../chunks/chunk-mFA2H-OE.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-Bo4eUEEe.js";import{U as d}from"../chunks/chunk-dpNjuz7w.js";/* empty css                      *//* empty css                      *//* empty css                      */const c=[{pageSectionId:"ignored-directories",pageSectionLevel:2,pageSectionTitle:"Ignored directories"},{pageSectionId:"case-sensitive",pageSectionLevel:2,pageSectionTitle:"Case sensitive"},{pageSectionId:"crawl-space",pageSectionLevel:2,pageSectionTitle:"Crawl space"},{pageSectionId:"renderer",pageSectionLevel:2,pageSectionTitle:"`renderer/`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(i){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Detailed information about Vike's Filesystem Routing."}),`
...
You can use symlinks (e.g. `,e.jsx(n.code,{children:"$ ln -s"}),") and set ",e.jsx(n.code,{children:'VIKE_CRAWL="{git:false}"'})," to make a directory outside of ",e.jsx(n.code,{children:"root"})," crawlable."]}),`
`]}),`
`]}),`
