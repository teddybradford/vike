import{j as e,i as d,L as o,o as s}from"../chunks/chunk-4-KYXii0.js";import{L as n}from"../chunks/chunk-T6aKCTvk.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CPdZ0D9I.js";/* empty css                      */const c=[{pageSectionId:"throw-redirect-vs-throw-render-vs-navigate",pageSectionLevel:2,pageSectionTitle:"`throw redirect()` VS `throw render()` VS `navigate()`"},{pageSectionId:"debug",pageSectionLevel:2,pageSectionTitle:"Debug"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(t){const r={blockquote:"blockquote",br:"br",code:"code",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(r.p,{children:["You can use ",e.jsx(n,{href:"/render",children:e.jsx(r.code,{children:"throw render()"})})," or ",e.jsx(n,{href:"/redirect",children:e.jsx(r.code,{children:"throw redirect()"})})," in order to abort rendering the current page and render something else instead."]}),`
...
`,"In development, check your server logs for the following log. If the log is missing then it means that Vike didn't catch the ",e.jsx(r.code,{children:"throw redirect()"})," / ",e.jsx(r.code,{children:"throw render()"})," exception: some other code is intercepting it and thus prevents Vike from catching it.",`
...
`})}),`
`,e.jsxs(r.blockquote,{children:[`
`,e.jsxs(r.p,{children:["Most notably, using ",e.jsx(r.code,{children:"throw redirect()"})," / ",e.jsx(r.code,{children:"throw render()"})," inside a UI component usually doesn't work because most ",e.jsx(n,{href:"/ui-frameworks",children:"UI frameworks"})," will intercept the exception, and thus Vike won't be able to catch it. Instead, consider using ",e.jsx(r.code,{children:"throw redirect()"})," / ",e.jsx(r.code,{children:"throw render()"})," in a Vike hook such as ",e.jsx(n,{href:"/guard",children:e.jsx(r.code,{children:"guard()"})})," or ",e.jsx(n,{href:"/data",children:e.jsx(r.code,{children:"data()"})}),", or use ",e.jsx(n,{href:"/navigate",children:e.jsx(r.code,{children:"navigate()"})}),"."]}),`
`]}),`
`]}),`
...
`,"If you've embedded Vike into your server using ",e.jsx(n,{text:e.jsx(r.code,{children:"renderPage()"}),href:"/renderPage"}),", then inspect whether ",e.jsx(r.code,{children:"pageContext.httpResponse.headers"})," contains the ",e.jsx(r.code,{children:"Location"})," header and double check that you're correctly adding all the headers defined by ",e.jsx(r.code,{children:"pageContext.httpResponse.headers"})," to the HTTP response."]}),`
`]}),`
