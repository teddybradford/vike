import{j as e,b as r,L as a,o,i as d}from"../chunks/chunk-B4V7wIR1.js";import{L as n}from"../chunks/chunk-DWcoZmvA.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BdLdLbhk.js";import{U as l}from"../chunks/chunk-CH3RbVSa.js";/* empty css                      *//* empty css                      */const h=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function s(t){const i={a:"a",blockquote:"blockquote",code:"code",li:"li",ol:"ol",p:"p",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(i.p,{children:["The following shows how to add SSR / ",e.jsx(n,{href:"/pre-rendering",children:"pre-rendering (aka SSG)"})," to an existing ",e.jsx(i.a,{href:"https://vitejs.dev",children:"Vite"})," app:"]}),`
...
`]}),`
`]}),`
`,e.jsxs(i.li,{children:["add a ",e.jsx(n,{href:"/express",children:"Express.js"}),"/",e.jsx(n,{href:"/hono",children:"Hono"}),"/",e.jsx(n,{href:"/fastify",children:"Fastify"}),"/",e.jsx(n,{href:"/server",children:"..."})," server (or add ",e.jsx(n,{href:"/renderPage",children:"Vike's server middleware"})," if you already have one).",`
`,e.jsxs(i.blockquote,{children:[`
