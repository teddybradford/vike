import{j as e,i as t,L as a,o as i}from"../chunks/chunk-C7AcAwVM.js";import{L as s}from"../chunks/chunk-aTqX3hZC.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CtCUSfsW.js";/* empty css                      */const o=[{pageSectionId:"built-in",pageSectionLevel:2,pageSectionTitle:"Built-in"},{pageSectionId:"custom",pageSectionLevel:2,pageSectionTitle:"Custom"},{pageSectionId:"faq",pageSectionLevel:2,pageSectionTitle:"FAQ"},{pageSectionId:"can-i-mutate-pagecontext",pageSectionLevel:3,pageSectionTitle:"Can I mutate `pageContext`?"},{pageSectionId:"can-i-use-pagecontext-as-a-ui-store",pageSectionLevel:3,pageSectionTitle:"Can I use `pageContext` as a UI store?"},{pageSectionId:"can-i-check-whether-ssr-is-enabled",pageSectionLevel:3,pageSectionTitle:"Can I check whether SSR is enabled?"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"lifecycle",pageSectionLevel:2,pageSectionTitle:"Lifecycle"},{pageSectionId:"server",pageSectionLevel:3,pageSectionTitle:"Server"},{pageSectionId:"client",pageSectionLevel:3,pageSectionTitle:"Client"},{pageSectionId:"pre-rendering",pageSectionLevel:3,pageSectionTitle:"Pre-rendering"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"pageContext"})," object provides contextual information about the current page."]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["You can access ",e.jsx(n.code,{children:"pageContext"})," everywhere:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["At any UI component, by using ",e.jsx(s,{href:"/usePageContext",children:e.jsx(n.code,{children:"usePageContext()"})}),"."]}),`
`,e.jsxs(n.li,{children:["At any ",e.jsx(s,{href:"/hooks",children:"Vike hook"})," (such as ",e.jsx(s,{href:"/data",children:e.jsx(n.code,{children:"+data"})}),")."]}),`
`,e.jsxs(n.li,{children:["On both the server and client (although you may need to use ",e.jsx(s,{href:"/passToClient",children:e.jsx(n.code,{children:"passToClient"})}),")."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["The server-side ",e.jsx(n.code,{children:"pageContext"})," of a ",e.jsx(s,{href:"/pre-rendering",children:"pre-rendered"})," page is determined at build-time when the page is pre-rendered."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Each pre-rendered page has a ",e.jsx(n.code,{children:"pageContext"})," object saved at ",e.jsx(n.code,{children:"dist/client/${url}/index.pageContext.json"}),"."]}),`
`]}),`
`,e.jsxs(n.p,{children:["This means that, if the first page the user visits is a pre-rendered page, then the ",e.jsx(n.code,{children:"pageContext"})," was already determined (potentially a long time) before the user visits that page."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Consequently, if the user visits the URL ",e.jsx(n.code,{children:"/products?filter=computer"})," then ",e.jsx(n.code,{children:"pageContext.urlParsed.search"})," is empty and ",e.jsx(n.code,{children:"?filter=computer"})," is missing."]}),`
`,e.jsxs(n.p,{children:["In theory, Vike could update ",e.jsx(n.code,{children:"pageContext"})," on the client-side and add ",e.jsx(n.code,{children:"?filter=computer"})," to ",e.jsx(n.code,{children:"pageContext.urlParsed"})," but this would lead to a ",e.jsx(s,{href:"/hydration-mismatch",children:"hydration mismatch"}),". That's why, upon hydration, Vike intentionally keeps the client- and server-side ",e.jsx(n.code,{children:"pageContext"})," aligned for hydration."]}),`
`,e.jsx(n.p,{children:"Workarounds:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Re-render the page after hydration, by using ",e.jsx(s,{href:"/reload",children:e.jsx(n.code,{children:"reload()"})})," and ",e.jsx(s,{href:"/onHydrationEnd",children:e.jsx(n.code,{children:"onHydrationEnd()"})}),":",`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`]}),`
`,e.jsxs(n.li,{children:["If the number of ",e.jsx(n.code,{children:"?filter="})," values isn't too large then, instead of ",e.jsx(n.code,{children:"?filter="}),", you can use a ",e.jsxs(s,{href:"/routing#parameterized-routes",children:["paramterized route ",e.jsx(n.code,{children:"/products/@filter"})]})," together with ",e.jsx(s,{href:"/onBeforePrerenderStart",children:e.jsx(n.code,{children:"onBeforePrerenderStart()"})})," for pre-rendering all filter values: ",e.jsx(n.code,{children:"/products/computer"}),", ",e.jsx(n.code,{children:"/products/car"}),", ..."]}),`
`]}),`
`]}),`
`,e.jsxs(n.p,{children:["Upon client-side navigation, the ",e.jsx(n.code,{children:"pageContext"})," of the new page is determined dynamically at runtime on the client-side."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Unlike hydration, upon client-side navigation the ",e.jsx(n.code,{children:"pageContext"})," is up-to-date and ",e.jsx(n.code,{children:"pageContext.urlParsed.search"})," includes query parameters such as ",e.jsx(n.code,{children:"?filter=computer"}),"."]}),`
`]}),`
