...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`]}),`
`,e.jsxs(n.li,{children:["If the number of filters isn't infinite, then you can use a ",e.jsx(s,{href:"/routing#parameterized-routes",children:"paramterized route"})," ",e.jsx(n.code,{children:"/products/@filter"})," with ",e.jsx(s,{href:"/onBeforePrerenderStart",children:e.jsx(n.code,{children:"onBeforePrerenderStart()"})})," in order to pre-render all filters (",e.jsx(n.code,{children:"/products/computer"}),", ",e.jsx(n.code,{children:"/products/car"}),", ...)."]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Unlike hydration, on client-side navigation, the ",e.jsx(n.code,{children:"pageContext"})," is up-to-date, and ",e.jsx(n.code,{children:"pageContext.urlParsed.search"})," includes query parameters such as ",e.jsx(n.code,{children:"?filter=computer"}),"."]}),`
`]}),`
