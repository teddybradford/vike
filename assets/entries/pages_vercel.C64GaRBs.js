import{j as e,o as l,i as s}from"../chunks/chunk-QQHFLgus.js";import{L as o}from"../chunks/chunk-DJTIoNMK.js";/* empty css                      */import{W as a}from"../chunks/chunk-MyxA_kY3.js";import{U as d}from"../chunks/chunk-HYVxFv7i.js";import{E as n}from"../chunks/chunk-DFhVjdo2.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-7E_FEcaS.js";/* empty css                      */const c=[{pageSectionId:"api-route",pageSectionLevel:2,pageSectionTitle:"API Route"},{pageSectionId:"vite-plugin-vercel",pageSectionLevel:2,pageSectionTitle:"vite-plugin-vercel"},{pageSectionId:"build-output-api",pageSectionLevel:2,pageSectionTitle:"Build Output API"},{pageSectionId:"data-apis-graphql-restful-rpc",pageSectionLevel:2,pageSectionTitle:"Data APIs (GraphQL, RESTful, RPC)"}];function r(i){const t={a:"a",blockquote:"blockquote",code:"code",li:"li",ol:"ol",p:"p",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.p,{children:["You can deploy Vike to ",e.jsx(t.a,{href:"https://vercel.com",children:"Vercel"})," simply by using a Vercel API Route. Alternatively, you can use ",e.jsx(t.code,{children:"vite-plugin-vercel"})," for a full-fleged Vercel integration with ISR and Edge Middlewares."]}),`
...
`,e.jsxs(t.p,{children:["If you ",e.jsx(o,{text:"pre-render your pages only partially",href:"/prerender#partial"}),", you can also use ",e.jsx(t.code,{children:"vite-plugin-vercel"})," to statically deploy your pre-rendered pages while dynamically serving your non-prerendered pages."]}),`
`,e.jsxs(t.blockquote,{children:[`
