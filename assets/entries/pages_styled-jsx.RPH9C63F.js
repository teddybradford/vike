import{j as e,o as a,i as t}from"../chunks/chunk-KSltIhmt.js";import{L as n}from"../chunks/chunk-DPhxMA0u.js";/* empty css                      */import{U as o}from"../chunks/chunk-ScrxolXu.js";import{E as i}from"../chunks/chunk-BHpQ95Wb.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B0bomZhE.js";/* empty css                      */const c=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["You can use Vike with ",e.jsx(s.a,{href:"https://github.com/vercel/styled-jsx",children:e.jsx(s.code,{children:"styled-jsx"})}),"."]}),`
`,e.jsx(s.p,{children:"Example:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(i,{timestamp:"2023.07",repo:"jeremypress/vite-ssr-styled-jsx"}),`
...
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["When using a CSS-in-JS tool, like ",e.jsx(s.code,{children:"styled-jsx"}),", you always need to collect the page's styles upon SSR in order ",e.jsx(n,{href:"/css-tools#collect-styles-upon-ssr",children:"to avoid FOUC"}),"."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(o,{name:!0}),", then see ",e.jsx(n,{href:"/css-tools#collect-styles-upon-ssr",doNotInferSectionTitle:!0}),"."]}),`
`]}),`
