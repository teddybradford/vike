import{j as e,b as i,o as t,i as r}from"../chunks/chunk-KSltIhmt.js";import{L as s}from"../chunks/chunk-DPhxMA0u.js";/* empty css                      */import{U as o}from"../chunks/chunk-ScrxolXu.js";import{U as d}from"../chunks/chunk-2BFdoaJl.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B0bomZhE.js";/* empty css                      */const c=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"links-intercepting",pageSectionLevel:2,pageSectionTitle:"Links intercepting"},{pageSectionId:"hooks",pageSectionLevel:2,pageSectionTitle:"Hooks"},{pageSectionId:"settings",pageSectionLevel:2,pageSectionTitle:"Settings"},{pageSectionId:"programmatic-navigation",pageSectionLevel:2,pageSectionTitle:"Programmatic navigation"},{pageSectionId:"state-initialization",pageSectionLevel:2,pageSectionTitle:"State initialization"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Environment: client."}),`
`,e.jsxs(n.p,{children:["If you don't use a ",e.jsx(o,{})," then Vike does ",e.jsx(s,{text:"Server Routing",href:"/server-routing"})," by default."]}),`
...
`,e.jsx(d,{featureName:"Client Routing"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:'<a href="/some/url" keep-scroll-position>'}),": Don't scroll to the top of the page, preserve the scroll position instead. See also ",e.jsx(s,{href:"/navigate#options",children:e.jsx(n.code,{children:"navigate('/some-url', { keepScrollPosition: true })"})}),"."]}),`
