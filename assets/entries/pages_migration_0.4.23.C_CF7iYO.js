...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onBeforeRoute()"})," and ",e.jsx(n.code,{children:"onBeforePrerender()"})," hooks are usually only used for i18n, see ",e.jsx(t,{href:"/i18n"}),"."]}),`
`]}),`
