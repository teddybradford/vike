import{j as e,i as o,L as t,o as c}from"../chunks/chunk-EEKjKfLM.js";import{L as n}from"../chunks/chunk-DHhiHNOQ.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-5ryOTDYD.js";import{T as d,a as h,b as r,c as a}from"../chunks/chunk-CnKWUKGo.js";/* empty css                      *//* empty css                      */const p=[{pageSectionId:"zero-config",pageSectionLevel:2,pageSectionTitle:"Zero-config"},{pageSectionId:"hmr",pageSectionLevel:2,pageSectionTitle:"HMR"},{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"releasing-1-0",pageSectionLevel:2,pageSectionTitle:"Releasing `1.0`"},{pageSectionId:"vite-s-environment-api",pageSectionLevel:2,pageSectionTitle:"Vite's Environment API"},{pageSectionId:"sharing-with-other-frameworks",pageSectionLevel:2,pageSectionTitle:"Sharing with other frameworks"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["We (",e.jsx(n,{href:"/team",children:"Joël, Dani, and Rom"}),") have been working on a ",e.jsxs(n,{href:"/server",children:["new Vike extension ",e.jsx(s.code,{children:"vike-server"})]})," that can integrate Vite with any server (Express.js, Hono, Fastify, Elysia, H3, ...) and any deployment (VPS, Netlify, Cloudflare, Vercel, ...)."]}),`
`,e.jsxs(s.p,{children:["With ",e.jsx(s.code,{children:"vike-server"})," you get:"]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Server code ",e.jsx(s.strong,{children:"transpiled by Vite"})," (say goodbye to ",e.jsx(s.code,{children:"ts-node"}),"/",e.jsx(s.code,{children:"tsx"}),"/",e.jsx(s.code,{children:"vavite"})," and you can now use utilities such as ",e.jsx(s.code,{children:"import.meta.env"}),")"]}),`
...
`]}),`
`,e.jsxs(s.p,{children:["We've been beta testing it for many months and it's now stable and released as ",e.jsx(s.code,{children:"1.0.0"})," — you can use it in production."]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["Unsurprisingly, using Vite to transpile server code was one of the most requested features. In fact this was Vike's last significant shortcoming: Vike can now be considered a full-fledged framework. We're a lot ",e.jsxs(n,{href:"#releasing-1-0",children:["closer to releasing ",e.jsx(s.code,{children:"vike@1.0.0"})]}),"!"]}),`
`]}),`
...
`]}),`
`]}),`
`,e.jsx(s.p,{children:"There is still some boilerplate code, but we're working towards also having a completely zero-config setup."}),`
...
`,e.jsx(s.p,{children:"Beyond stability, we're working on making Vike's core feature-complete (no known blockers) and highly polished (state-of-the-art DX)."}),`
