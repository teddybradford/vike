import{j as e,b as a,L as o,o as i,i as t}from"../chunks/chunk-BmDL4gbL.js";import{L as n}from"../chunks/chunk-CfId5D-w.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-OYyQQBLV.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"login-flow",pageSectionLevel:2,pageSectionTitle:"Login flow"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["To make information about the authenticated user available to your pages and UI components, you usually define ",e.jsx(s.code,{children:"pageContext.user"})," at ",e.jsx(s.a,{href:"/renderPage",children:e.jsx(s.code,{children:"renderPage()"})}),":"]}),`
