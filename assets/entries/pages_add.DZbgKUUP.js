import{j as e,b as r,L as a,o,i as d}from"../chunks/chunk-BmDL4gbL.js";import{L as n}from"../chunks/chunk-CfId5D-w.js";/* empty css                      *//* empty css                      *//* empty css                      */import{U as t}from"../chunks/chunk-Cwv4EFWV.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-OYyQQBLV.js";/* empty css                      *//* empty css                      */const h=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function l(s){const i={a:"a",blockquote:"blockquote",code:"code",li:"li",ol:"ol",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(i.p,{children:["The following shows how to add SSR / ",e.jsx(n,{href:"/pre-rendering",children:"pre-rendering (aka SSG)"})," to an existing ",e.jsx(i.a,{href:"https://vitejs.dev",children:"Vite"})," app:"]}),`
...
`,e.jsxs(i.li,{children:["With or without ",e.jsx(t,{name:!0,list:["vike-react","vike-vue"]}),"."]}),`
...
`]}),`
`,e.jsxs(i.p,{children:["You can choose whether you want to migrate towards a full-fledged SSR/SSG framework DX (like Next.js and Nuxt by using ",e.jsx(t,{name:!0}),"), or add a minimal SSR/SSG implementation (applying a minimal amount of changes to your existing code), or something in-between."]}),`
...
`,e.jsx(i.p,{children:"Either:"}),`
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:["Use ",e.jsx(t,{name:!0}),", or"]}),`
