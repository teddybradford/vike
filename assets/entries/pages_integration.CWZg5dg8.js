import{j as e,i,L as a,o as t}from"../chunks/chunk-h3bYPDVF.js";import{L as s}from"../chunks/chunk-Ykj57Jia.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DPVKd4q0.js";import{I as o}from"../chunks/chunk-COuHbLmt.js";import{M as c}from"../chunks/chunk-DaQi6Kw6.js";/* empty css                      */import{M as d}from"../chunks/chunk-aKtqbAkW.js";/* empty css                      */import"../chunks/chunk-BHuVOxQI.js";const h=[{pageSectionId:"vanilla-ui-tools",pageSectionLevel:2,pageSectionTitle:"Vanilla UI tools"},{pageSectionId:"analytics",pageSectionLevel:2,pageSectionTitle:"Analytics"},{pageSectionId:"component-libraries",pageSectionLevel:2,pageSectionTitle:"Component libraries"},{pageSectionId:"data-fetching",pageSectionLevel:2,pageSectionTitle:"Data fetching"},{pageSectionId:"service-worker",pageSectionLevel:2,pageSectionTitle:"Service worker"},{pageSectionId:"view-transitions",pageSectionLevel:2,pageSectionTitle:"View transitions"},{pageSectionId:"ui-framework",pageSectionLevel:2,pageSectionTitle:"UI framework"},{pageSectionId:"non-javascript-backend",pageSectionLevel:2,pageSectionTitle:"Non-JavaScript Backend"},{pageSectionId:"server-manual-integration",pageSectionLevel:2,pageSectionTitle:"Server (manual integration)"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{}),`
`,e.jsx("h2",{id:"vanilla-ui-tools",children:"Vanilla UI tools"}),`
`,e.jsxs(n.p,{children:["To initialize UI vanilla tools (jQuery, tooltips, ...) you can use the ",e.jsxs(s,{href:"/onHydrationEnd",children:[e.jsx(n.code,{children:"onHydrationEnd()"})," hook"]}),"."]}),`
...
`,e.jsx(s,{href:"/Head",noBreadcrumb:!0}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/bodyHtmlEnd"}),`
`]}),`
`]}),`
`,e.jsxs(n.p,{children:["You can use the ",e.jsx(s,{href:"/client",children:e.jsx(n.code,{children:"+client.js"})})," file to initialize analytics code."]}),`
...
`,e.jsxs(n.p,{children:["You can also load and/or initialize analytics code only after the hydration ends by using the ",e.jsx(s,{href:"/onHydrationEnd",children:"+onHydrationEnd"})," hook."]}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/client",noBreadcrumb:!0}),`
`]}),`
`]}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/bodyHtmlEnd",noBreadcrumb:!0}),`
`]}),`
`]}),`
`,e.jsx(n.p,{children:"Examples:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/vuetify"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/mantine"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/daisyui"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/tools#component-libraries",children:"... more"}),`
`]}),`
`]}),`
`,e.jsx("h2",{id:"data-fetching",children:"Data fetching"}),`
`,`
`,e.jsxs(n.p,{children:["Instead of using ",e.jsxs(s,{href:"/data",children:["the ",e.jsx(n.code,{children:"+data"})," hook"]}),", you can use ",e.jsx(s,{href:"/data-fetching#tools",children:"tools to fetch the page's initial data"}),"."]}),`
`,e.jsx(d,{children:e.jsxs(n.p,{children:["The following explains how to integrate tools for fetching initial data. Instead of manually integrating tools yourself, we generally recommend using ",e.jsx(s,{href:"/extensions",children:"Vike extensions"})," such as ",e.jsx(n.a,{href:"https://github.com/vikejs/vike-react/tree/main/packages/vike-react-apollo#readme",children:e.jsx(n.code,{children:"vike-react-apollo"})})," or ",e.jsx(n.a,{href:"https://github.com/vikejs/vike-vue/tree/main/packages/vike-vue-query#readme",children:e.jsx(n.code,{children:"vike-vue-query"})}),"."]})}),`
`,e.jsxs(n.p,{children:["Some data-fetching tools enable you to fetch a page's initial data on a component-level instead of ",e.jsxs(s,{href:"/data-fetching#data-hook",children:["using the page-level Vike hook ",e.jsx(n.code,{children:"data()"})]})]}),`
...
`,e.jsxs(n.li,{children:["The initial data is serialized and passed to the client. (So that the client uses the exact same data, avoiding double-fetching and ",e.jsx(s,{href:"/hydration-mismatch",children:"hydration mismatches"}),".)"]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["If ",e.jsx(s,{href:"/ssr",children:"SSR is disabled"}),", then the data is only fetched on the client-side. (The component's data is fetched where the component is loaded and executed.)"]}),`
`]}),`
`,e.jsxs(n.p,{children:["Some tools provide utilities to integrate more or less automatically. For example ",e.jsx(s,{href:"/apollo-graphql",children:"Apollo GraphQL"})," provides many utilities to make integration easy."]}),`
`,e.jsx(n.p,{children:"A fully manual integration can be done as follows:"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:["Determine the initial data on the server side (after SSR) and ",e.jsxs(s,{href:"/pageContext#custom",children:["make it available as ",e.jsx(n.code,{children:"pageContext.dataInitial"})]}),"."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["You can configure/initialize the tool's client at ",e.jsx(s,{href:"/onBeforeRenderHtml",children:e.jsx(n.code,{children:"onBeforeRenderHtml()"})}),":"]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(n.p,{children:["You can determine the initially fetched data at ",e.jsx(s,{href:"/onAfterRenderHtml",children:e.jsx(n.code,{children:"onAfterRenderHtml()"})}),":"]}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:["Make ",e.jsx(n.code,{children:"pageContext.dataInitial"})," available to the client-side by using ",e.jsx(s,{href:"/passToClient",children:e.jsx(n.code,{children:"passToClient"})}),"."]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/tools#data-fetching"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`,e.jsxs(n.p,{children:["You can use the ",e.jsx(s,{href:"/client",children:e.jsx(n.code,{children:"+client.js"})})," file to initialize ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API",children:"service workers"}),"."]}),`
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// pages/+client.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
...
`,e.jsx("h2",{id:"view-transitions",children:"View transitions"}),`
`,e.jsxs(n.p,{children:["You can use ",e.jsx(s,{href:"/navigate",children:e.jsx(n.code,{children:"navigate()"})})," to implement ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/API/View_Transition_API/Using",children:"View Transitions"}),", see ",e.jsx(n.a,{href:"https://github.com/blankeos/vike-view-transitions",children:"Tutorial on how to do View Transitions with Vike"}),"."]}),`
`,e.jsx("h2",{id:"ui-framework",children:"UI framework"}),`
`,e.jsxs(n.p,{children:["You can manually integrate React/Vue/Solid (",e.jsx(s,{href:"/ui-frameworks",children:"or any other UI framework"}),") yourself:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/react#custom-integration"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/vue#custom-integration"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/solid#custom-integration"}),`
`]}),`
`]}),`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The Vike extensions ",e.jsx(n.code,{children:"vike-react"}),"/",e.jsx(n.code,{children:"vike-vue"}),"/",e.jsx(n.code,{children:"vike-solid"})," aim to be almost as flexible. If you reach a limitation you believe is caused by ",e.jsx(n.code,{children:"vike-{react,vue,solid}"})," then ",e.jsx(s,{href:"/extension-vs-custom",children:"reach out before considering going for a manual integration"}),"."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:["Your Vike app uses that REST/GraphQL API to ",e.jsx(s,{href:"/ssr",children:"render your pages to HTML with SSR or SSG"}),". (The client-side of your Vike app then ",e.jsx(s,{href:"/hydration",children:"hydrates"})," the HTML into a rich interactive user interface.)"]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["Alternatively, instead of using a JavaScript server, you can ",e.jsx(s,{href:"/pre-rendering",children:"pre-render"})," your pages (SSG) while ",e.jsx(s,{href:"/ssr",children:"disabling SSR"}),". In other words: you generate empty HTML shells that you statically deploy (using a ",e.jsx(s,{href:"/static-hosts",children:"static host"}),", or using your own static assets deployment)."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The HTML must be generated by Vike because the UI is ",e.jsx(n.em,{children:"completely"})," owned by React/Vue/Solid. You cannot generate the HTML using your non-JavaScript backend: React/Vue/Solid would otherwise throw a ",e.jsx(s,{href:"/hydration-mismatch",children:"hydration mismatch"}),"."]}),`
`]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/ruby-on-rails"}),`
`]}),`
`]}),`
`,e.jsx(n.p,{children:"See also:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"#server-manual-integration",doNotInferSectionTitle:!0}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/server"}),`
`]}),`
`]}),`
`,e.jsx("h2",{id:"server-manual-integration",children:"Server (manual integration)"}),`
`,e.jsxs(n.p,{children:["In general, ",e.jsxs(s,{href:"/server",children:["we recommend using ",e.jsx(n.code,{children:"vike-server"})]})," which automatically integrates Vike with your JavaScript server (Express.js, Hono, Fastify, ...). But you can, instead, manually integrate Vike into your server if you prefer."]}),`
`,e.jsx(c,{}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/express"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/hono"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/fastify"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/docker",noBreadcrumb:!0}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/nginx"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/tools#server",children:"... more"}),`
`]}),`
`]}),`
`,e.jsx(n.p,{children:"See also:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"#non-javascript-backend",doNotInferSectionTitle:!0}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/server"}),`
`]}),`
...
`,e.jsx(s,{href:"/tools"}),`
`]}),`
`]})]})}function p(l={}){const{wrapper:n}=l.components||{};return n?e.jsx(n,{...l,children:e.jsx(r,{...l})}):r(l)}const x=Object.freeze(Object.defineProperty({__proto__:null,default:p,pageSectionsExport:h},Symbol.toStringTag,{value:"Module"})),I={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:t}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/integration/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:x}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}},Layout:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/Layout",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:a}},TopNavigation:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/+TopNavigation.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:i}}};export{I as configValuesSerialized};
