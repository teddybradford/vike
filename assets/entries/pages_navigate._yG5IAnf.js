...
`,e.jsxs(c,{children:[e.jsxs(n.strong,{children:["You must handle the ",e.jsx(n.code,{children:"popstate"})," event"]}),", otherwise you'll break the browser's back- and forward history button."]}),`
