import{j as e,i,L as t,o as c}from"../chunks/chunk-BivJSGle.js";import{L as n}from"../chunks/chunk-B4r0_jyM.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B7FFhNjk.js";import{T as d,a as p,b as r,c as a}from"../chunks/chunk-e3hAYdgu.js";/* empty css                      *//* empty css                      */const h=[{pageSectionId:"zero-config",pageSectionLevel:2,pageSectionTitle:"Zero-config"},{pageSectionId:"hmr",pageSectionLevel:2,pageSectionTitle:"HMR"},{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"releasing-1-0",pageSectionLevel:2,pageSectionTitle:"Releasing `1.0`"},{pageSectionId:"vite-s-environment-api",pageSectionLevel:2,pageSectionTitle:"Vite's Environment API"},{pageSectionId:"sharing-with-other-frameworks",pageSectionLevel:2,pageSectionTitle:"Sharing with other frameworks"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["We (",e.jsx(n,{href:"/team",children:"Joël, Dani, and Rom"}),") are beyond thrilled to announce our collaborative work: a ",e.jsxs(n,{href:"/server",children:["new Vike extension ",e.jsx(s.code,{children:"vike-server"})]})," that can integrate Vite with any server (Express.js, Hono, Fastify, Elysia, H3, ...) and any deployment (VPS, Netlify, Cloudflare, Vercel, ...)."]}),`
`,e.jsxs(s.p,{children:["With ",e.jsx(s.code,{children:"vike-server"})," you get:"]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Server code ",e.jsx(s.strong,{children:"transpiled by Vite"})," (say goodbye to ",e.jsx(s.code,{children:"ts-node"}),"/",e.jsx(s.code,{children:"tsx"})," and you can now use utilities such as ",e.jsx(s.code,{children:"import.meta.env"}),")"]}),`
...
`]}),`
`,e.jsxs(s.p,{children:["We've been beta testing it for many months already. It's now stable and released as ",e.jsx(s.code,{children:"1.0.0"})," — you can use it in production."]}),`
