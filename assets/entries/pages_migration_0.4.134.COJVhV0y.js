import{j as e,o as l,i as t}from"../chunks/chunk-QQHFLgus.js";import{L as r}from"../chunks/chunk-DJTIoNMK.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-7E_FEcaS.js";/* empty css                      */const i=[{pageSectionId:"express-js",pageSectionLevel:2,pageSectionTitle:"Express.js"},{pageSectionId:"cloudflare-workers",pageSectionLevel:2,pageSectionTitle:"Cloudflare Workers"},{pageSectionId:"vercel",pageSectionLevel:2,pageSectionTitle:"Vercel"}];function a(s){const n={blockquote:"blockquote",code:"code",figure:"figure",p:"p",pre:"pre",span:"span",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"0.4.134"})," release soft-deprecates ",e.jsx(n.code,{children:"pageContext.httpResponse.contentType"})," in favor of ",e.jsx(n.code,{children:"pageContext.httpResponse.headers"}),"."]}),`
`,e.jsx(n.p,{children:"See the sections below for how to migrate."}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"0.4.134"})," release adds built-in support for ",e.jsx(r,{text:"URL redirections",href:"/redirect"})," and that's why the new property ",e.jsx(n.code,{children:"pageContext.httpResponse.headers"})," is needed."]}),`
`]}),`
