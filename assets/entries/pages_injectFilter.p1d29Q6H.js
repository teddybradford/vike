import{j as e,o as a,i as t}from"../chunks/chunk-QQHFLgus.js";import{L as n}from"../chunks/chunk-DJTIoNMK.js";/* empty css                      */import{W as o}from"../chunks/chunk-MyxA_kY3.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-7E_FEcaS.js";/* empty css                      */const i=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"usage",pageSectionLevel:2,pageSectionTitle:"Usage"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"injectFilter()"})," hook allows you to control where and what tags Vike injects in the HTML, most notably ",e.jsx(n,{href:"/preloading",children:"preload"})," tags."]}),`
...
`]}),`
`,e.jsxs(o,{children:[e.jsx(s.code,{children:"injectFilter()"})," is a beta feature. (Which means breaking changes may occur during any minor version update.)"]}),`
