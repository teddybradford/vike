import{j as e,i,L as t,o as c}from"../chunks/chunk-D87NQbdk.js";import{L as n}from"../chunks/chunk-OzoxVDhD.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BI6e2m4i.js";import{T as d,a as p,b as r,c as a}from"../chunks/chunk-CRJj7iA9.js";/* empty css                      *//* empty css                      */const h=[{pageSectionId:"zero-config",pageSectionLevel:2,pageSectionTitle:"Zero-config"},{pageSectionId:"hmr",pageSectionLevel:2,pageSectionTitle:"HMR"},{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"releasing-1-0",pageSectionLevel:2,pageSectionTitle:"Releasing `1.0`"},{pageSectionId:"vite-s-environment-api",pageSectionLevel:2,pageSectionTitle:"Vite's Environment API"},{pageSectionId:"sharing-with-other-frameworks",pageSectionLevel:2,pageSectionTitle:"Sharing with other frameworks"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(l){const s={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["We (",e.jsx(n,{href:"/team",children:"Joël, Dani, and Rom"}),") are beyond thrilled to announce a ",e.jsxs(n,{href:"/server",children:["new Vike extension ",e.jsx(s.code,{children:"vike-server"})]})," that can integrate Vite with any server (Express.js, Hono, Fastify, Elysia, H3, ...) and any deployment (VPS, Netlify, Cloudflare, Vercel, ...)."]}),`
...
`,e.jsxs(s.p,{children:["Using Vite to transpile server code was one of the most requested features (unsurprisingly so). In fact, this was Vike's last significant shortcoming and Vike can now be considered a full-fledged framework. We're a lot ",e.jsxs(n,{href:"#releasing-1-0",children:["closer to releasing ",e.jsx(s.code,{children:"1.0"})]}),"!"]}),`
`]}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["Vike is automatically added to your server — no need to manually integrate ",e.jsx(n,{href:"/renderPage",children:"renderPage()"})," anymore."]}),`
`]}),`
...
`,e.jsx(s.li,{children:"Lot's of polishing. (This will introduce several minor breaking changes.)"}),`
`]}),`
...
`,e.jsx(s.p,{children:"Sharing is caring 😊"}),`
