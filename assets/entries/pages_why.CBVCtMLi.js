import{j as e,L as t,o as s,i as a}from"../chunks/chunk-CKKSsm7N.js";import{L as i}from"../chunks/chunk-CTGdD0dX.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DMlpz8Zp.js";/* empty css                      *//* empty css                      */const l=[{pageSectionId:"architecture",pageSectionLevel:2,pageSectionTitle:"Architecture"},{pageSectionId:"flexible-by-design",pageSectionLevel:3,pageSectionTitle:"Flexible by design"},{pageSectionId:"flexible-and-reliable-by-prioritization",pageSectionLevel:3,pageSectionTitle:"Flexible and reliable, by prioritization"},{pageSectionId:"conservative-or-cutting-edge-your-choice",pageSectionLevel:3,pageSectionTitle:"Conservative or cutting-edge, your choice"},{pageSectionId:"grow-progressively",pageSectionLevel:3,pageSectionTitle:"Grow progressively"},{pageSectionId:"future-proof",pageSectionLevel:3,pageSectionTitle:"Future-proof"},{pageSectionId:"build-your-own-framework",pageSectionLevel:3,pageSectionTitle:"Build your own framework"},{pageSectionId:"philosophy",pageSectionLevel:2,pageSectionTitle:"Philosophy"},{pageSectionId:"separation-of-concerns",pageSectionLevel:3,pageSectionTitle:"Separation of concerns"},{pageSectionId:"flourishing-do-one-thing-do-it-well-ecosystem",pageSectionLevel:3,pageSectionTitle:"Flourishing do-one-thing-do-it-well ecosystem"},{pageSectionId:"user-driven",pageSectionLevel:3,pageSectionTitle:"User-driven"},{pageSectionId:"next-generation-business-model",pageSectionLevel:3,pageSectionTitle:"Next-generation business model"},{pageSectionId:"leadership",pageSectionLevel:3,pageSectionTitle:"Leadership"}];function r(o){const n={blockquote:"blockquote",code:"code",li:"li",p:"p",strong:"strong",ul:"ul",...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Deep dive into what makes Vike special."}),`
...
`,e.jsx(n.li,{children:"Deployment (AWS, Cloudflare, Vercel, ...)"}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`,e.jsx(n.p,{children:"If you create a feature request and explain why it's blocking then we treat it with higher priority."}),`
`,e.jsx(n.p,{children:"We quickly fix bugs (usually under 24 hours)."}),`
`,e.jsxs(n.p,{children:["Vike's team is responsive and we provide ",e.jsx(i,{href:"/faq#how-can-i-reach-out-for-help",children:"a clear guideline"})," on how to receive reliable assistance."]}),`
...
`]}),`
`]}),`
`,e.jsx(n.p,{children:"Vike enables you to keep your current stack for as long as you want, while progressively migrating towards new tools and approaches at your own pace."}),`
`,e.jsx("h3",{id:"grow-progressively",children:"Grow progressively"}),`
`,e.jsxs(n.p,{children:["Not only can you ",e.jsx(i,{href:"#conservative-or-cutting-edge-your-choice",children:"adopt new technology at your pace"}),", but you can also progressively adapt your stack to your evolving needs:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"One page at a time"}),": you can ",e.jsx(i,{href:"/config#powerful",children:"change your stack progressively on a page-by-page basis"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"One architectural component at a time"}),": you can switch architectural components independently of each other."]}),`
`]}),`
`,e.jsx(n.p,{children:"Progressive migrations enable you to migrate faster and in parralel to iterating on your product."}),`
`,e.jsxs(n.blockquote,{children:[`
...
`,e.jsxs(n.li,{children:["You can start with ",e.jsx(i,{href:"/https://telefunc.com/RPC",children:"RPC"})," and, later if the need arises, you can progressively switch to GraphQL."]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["For example, Vike doesn't have built-in ",e.jsx(i,{href:"/https://telefunc.com/RPC",children:"RPC"})," (aka Server Actions). This flexibility enables RPC approaches to be developed and innovated independently of Vike."]}),`
...
`,e.jsx(n.p,{children:"Thanks to our Open Source Pricing your success directly translates into (financial) success for us."}),`
`,e.jsxs(n.blockquote,{children:[`
...
`]}),`
`,e.jsx("h3",{id:"next-generation-business-model",children:"Next-generation business model"}),`
`,e.jsxs(n.p,{children:["We carefully designed Vike's ",e.jsx(i,{href:"/pricing",children:"Open Source Pricing"})," to keep code 100% open source (MIT license) and 100% gratis for software engineers while asking companies to pay a small amount."]}),`
`,e.jsx(n.p,{children:"For a transparent and sustainable relationship while keeping Vike accessible to everyone."}),`
`,e.jsx("h3",{id:"leadership",children:"Leadership"}),`
`,e.jsxs(n.p,{children:["Vike is an ",e.jsx(n.strong,{children:"independent project 100% led by engineers"}),"."]}),`
`,e.jsxs(n.p,{children:["We don't serve the interests of any unrelated business: ",e.jsx(n.strong,{children:"we only serve the interests of our users"}),"."]}),`
`,e.jsxs(n.p,{children:["We are ",e.jsx(n.strong,{children:"passionate"})," about technology and deeply care about striving towards a ",e.jsx(n.strong,{children:"collaborative"})," society."]}),`
`,e.jsxs(n.p,{children:["Beyond Vike's unparalleled flexibility, we have a clear and ",e.jsx(n.strong,{children:"bold vision"})," to establish it as a superior Next.js/Nuxt alternative in other fundamental aspects as well."]})]})}function c(o={}){const{wrapper:n}=o.components||{};return n?e.jsx(n,{...o,children:e.jsx(r,{...o})}):r(o)}const d=Object.freeze(Object.defineProperty({__proto__:null,default:c,pageSectionsExport:l},Symbol.toStringTag,{value:"Module"})),w={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},Layout:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/Layout",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:t}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:s}},TopNavigation:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/+TopNavigation.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:a}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/why/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:d}}};export{w as configValuesSerialized};
