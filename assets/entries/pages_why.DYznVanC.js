...
`,e.jsx(n.p,{children:"Vike is driven by core principles."}),`
...
`,e.jsx(n.p,{children:"Vike is an independent project 100% led by engineers that don't serve the interests of any unrelated business: we only serve the interests of our users."}),`
...
`,e.jsxs(n.li,{children:["We carefully designed Vike's ",e.jsx(i,{href:"/pricing",children:"Open Source Pricing"})," to keep code 100% open source (MIT license) and 100% gratis for software engineers while asking companies to pay a small amount. For a transparent and sustainable relationship while keeping Vike accessible to everyone."]}),`
`]}),`
