import{j as e,L as l,o as r,i as o}from"../chunks/chunk-C8GxokWD.js";import{L as i}from"../chunks/chunk-mm-oLdAr.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */const a=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function s(t){const n={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Vike injects scripts at three possible positions:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"At the end of the HTML."}),`
`,e.jsx(n.li,{children:"At the beginning of the HTML."}),`
`,e.jsxs(n.li,{children:["At the beginning of the ",e.jsx(i,{href:"/streaming",children:"HTML stream"}),"."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["Alternatively, for a more fine-grained control of where and what assets Vike injects, use ",e.jsx(i,{href:"/injectFilter",children:e.jsx(n.code,{children:"injectFilter()"})}),"."]}),`
`]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Setting ",e.jsx(n.code,{children:"injectAssetsAt"})," to ",e.jsx(n.code,{children:"null"})," can be useful in the context of ",e.jsx(i,{href:"/config#inheritance",children:"config inheritance"}),"."]}),`
`]}),`
