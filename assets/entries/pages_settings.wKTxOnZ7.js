import{j as e,L as l,o as d,i as o}from"../chunks/chunk-Gr2vzjJM.js";import{L as i}from"../chunks/chunk-DKWj1Lor.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */function r({children:s}){return e.jsx("span",{style:{opacity:.85,fontSize:"0.9em",verticalAlign:"middle"},children:e.jsx("code",{children:s})})}const c=[{pageSectionId:"basic",pageSectionLevel:2,pageSectionTitle:"Basic"},{pageSectionId:"html",pageSectionLevel:3,pageSectionTitle:"HTML"},{pageSectionId:"advanced",pageSectionLevel:2,pageSectionTitle:"Advanced"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(s){const n={a:"a",blockquote:"blockquote",code:"code",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["List of built-in settings. (You can ",e.jsx(i,{href:"/meta",children:"create your own settings"}),".)"]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/routing",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"route"})})}),": ",e.jsx(r,{children:"string | Function"})," The page's route."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/prerender",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"prerender"})})}),": Whether to ",e.jsx(i,{href:"/pre-rendering",children:"pre-render"})," the page, and pre-rendering settings."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/client",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"client"})})}),": ",e.jsx(r,{children:"string"})," Add client code."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/extends",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"extends"})})}),": Install ",e.jsx(i,{href:"/extensions"}),"."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["You create your own custom HTML settings, see ",e.jsx(i,{href:"/head-tags#custom-settings"}),"."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/passToClient",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"passToClient"})})}),": ",e.jsx(r,{children:"string[]"})," Determines what ",e.jsx(n.code,{children:"pageContext"})," values are sent to the client-side."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/clientRouting",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"clientRouting"})})}),": ",e.jsx(r,{children:"boolean"})," Enable ",e.jsx(i,{href:"/client-routing",children:"Client Routing"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/hydrationCanBeAborted",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"hydrationCanBeAborted"})})}),": ",e.jsx(r,{children:"boolean"}),"  Whether your ",e.jsx(i,{text:"UI framework",href:"/ui-frameworks"})," allows the ",e.jsx(i,{href:"/hydration",children:"hydration"})," to be aborted."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/disableAutoFullBuild",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"disableAutoFullBuild"})})}),": Disable automatic chaining of build steps."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/clientHooks",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"clientHooks"})})}),": ",e.jsx(r,{children:"boolean"})," Whether hooks are loaded on the client-side."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/filesystemRoutingRoot",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"filesystemRoutingRoot"})})}),": URL root for ",e.jsx(i,{href:"/filesystem-routing",children:"Filesystem Routing"}),"."]}),`
