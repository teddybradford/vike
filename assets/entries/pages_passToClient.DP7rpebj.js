import{j as e,i as r,L as o,o as i}from"../chunks/chunk-CVtUPLfN.js";import{L as s}from"../chunks/chunk-BAnssLF5.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BRJSnKPv.js";/* empty css                      */const t=[{pageSectionId:"error",pageSectionLevel:2,pageSectionTitle:"Error"},{pageSectionId:"default",pageSectionLevel:2,pageSectionTitle:"Default"},{pageSectionId:"serialization",pageSectionLevel:2,pageSectionTitle:"Serialization"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Most ",e.jsx(s,{href:"/pageContext",children:e.jsx(n.code,{children:"pageContext"})})," values are available only on the server-side, but you can use ",e.jsx(n.code,{children:"passToClient"})," to make values available on the client-side."]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(n.p,{children:["Some values, such as ",e.jsx(n.code,{children:"pageContext.data"}),", are already passed to the client-side by ",e.jsx(s,{href:"#default",children:"default"}),"."]}),`
