import{j as e,i as l,L as t,o}from"../chunks/chunk-Dyx6o0_I.js";import{L as s}from"../chunks/chunk-DpzCUoca.js";/* empty css                      */import{W as a}from"../chunks/chunk-CWwmzFZm.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CilIbrw3.js";import{U as d}from"../chunks/chunk-iPmEFxQI.js";/* empty css                      *//* empty css                      *//* empty css                      */const c=[{pageSectionId:"ignored-directories",pageSectionLevel:2,pageSectionTitle:"Ignored directories"},{pageSectionId:"case-sensitive",pageSectionLevel:2,pageSectionTitle:"Case sensitive"},{pageSectionId:"crawl-space",pageSectionLevel:2,pageSectionTitle:"Crawl space"},{pageSectionId:"renderer",pageSectionLevel:2,pageSectionTitle:"`renderer/`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(i){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Detailed information about Vike's Filesystem Routing."}),`
...
`]}),`
`]}),`
`,e.jsxs(n.p,{children:["By default Vike uses Git (if your repository uses Git) to crawl your files. If you set ",e.jsx(n.code,{children:'VIKE_CRAWL="{git:false}"'})," then Vike uses ",e.jsx(n.a,{href:"https://github.com/SuperchupuDev/tinyglobby",children:e.jsx(n.code,{children:"tinyglobby"})})," instead."]}),`
