...
`,e.jsxs(c,{children:["You need to handle the ",e.jsx(n.code,{children:"popstate"})," event, otherwise you'll break the browser's back- and forward history button."]}),`
