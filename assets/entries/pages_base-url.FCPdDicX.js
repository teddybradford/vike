import{a,j as s,b as n,o as c,i as t}from"../chunks/chunk-DyoRqzik.js";import"../chunks/chunk-B0bomZhE.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */function r({prop:l}){a(!l.startsWith("import")),a(!l.startsWith("."));const e="import.meta."+l;return s.jsx("code",{children:e})}const i=[{pageSectionId:"base",pageSectionLevel:2,pageSectionTitle:"`base`"},{pageSectionId:"baseassets",pageSectionLevel:2,pageSectionTitle:"`baseAssets`"},{pageSectionId:"baseserver",pageSectionLevel:2,pageSectionTitle:"`baseServer`"}];function o(l){const e={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return s.jsxs(s.Fragment,{children:[s.jsxs(e.blockquote,{children:[`
