...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// serve() attaches the server to Node.js, Cloudflare, Vercel, Deno, Bun, ..."})}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:"serve()"})," attaches your server to Node.js, Cloudflare, Vercel, Deno, Bun, ...",`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsx(s.p,{children:"It enables you to define a single server entry while being able to target multiple environments (e.g. Node.js and Cloudflare have a different server attachment style)."}),`
`]}),`
`]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Vike is automatically added to your server — no need to manually integrate ",e.jsx(n,{href:"/renderPage",children:e.jsx(s.code,{children:"renderPage()"})})," anymore."]}),`
`,e.jsx(s.li,{children:"Static files are automatically served."}),`
`]}),`
`]}),`
`,e.jsx(s.p,{children:"There is still some boilerplate code, but we're working on also having a completely zero-config setup."}),`
...
`,e.jsx(s.p,{children:"Beyond stability, we're working on making Vike core feature-complete (no known blockers) and highly polished (state-of-the-art DX)."}),`
