import{j as e,o as a,i}from"../chunks/chunk-KSltIhmt.js";import{L as s}from"../chunks/chunk-DPhxMA0u.js";/* empty css                      */import{C as o}from"../chunks/chunk-BQPMfjnf.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B0bomZhE.js";/* empty css                      */const t=[{pageSectionId:"workaround",pageSectionLevel:2,pageSectionTitle:"Workaround"},{pageSectionId:"ssr-noexternal",pageSectionLevel:3,pageSectionTitle:"`ssr.noExternal`"},{pageSectionId:"vite-plugin-cjs-interop",pageSectionLevel:3,pageSectionTitle:"`vite-plugin-cjs-interop`"},{pageSectionId:"ssr-opt-out",pageSectionLevel:3,pageSectionTitle:"SSR opt-out"},{pageSectionId:"why",pageSectionLevel:2,pageSectionTitle:"Why"},{pageSectionId:"common-errors",pageSectionLevel:2,pageSectionTitle:"Common errors"},{pageSectionId:"cannot-use-import-statement-outside-a-module",pageSectionLevel:3,pageSectionTitle:"Cannot use import statement outside a module"},{pageSectionId:"named-export-not-found",pageSectionLevel:3,pageSectionTitle:"Named export not found"},{pageSectionId:"err-module-not-found",pageSectionLevel:3,pageSectionTitle:"ERR_MODULE_NOT_FOUND"},{pageSectionId:"err-unsupported-dir-import",pageSectionLevel:3,pageSectionTitle:"ERR_UNSUPPORTED_DIR_IMPORT"},{pageSectionId:"err-unknown-file-extension-css",pageSectionLevel:3,pageSectionTitle:"ERR_UNKNOWN_FILE_EXTENSION .css"},{pageSectionId:"cannot-read-properties-of-undefined",pageSectionLevel:3,pageSectionTitle:"Cannot read properties of undefined"},{pageSectionId:"react-invalid-component",pageSectionLevel:3,pageSectionTitle:"React invalid component"}];function l(r){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Some npm packages contain invalid JavaScript code."}),`
...
`,e.jsx(n.p,{children:"By default, Vite doesn't transpile the server-side code of npm packages for a faster development DX, so that Node.js directly executes server-side code without involving a slow transpilition process."}),`
...
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{className:"has-diff",style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsxs(n.span,{className:"diff remove","data-line":"",children:[e.jsx(n.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(n.span,{style:{color:"#24292E"},children:" DefaultImport "}),e.jsx(n.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(n.span,{style:{color:"#032F62"},children:' "some-library"'}),e.jsx(n.span,{style:{color:"#24292E"},children:"; "})]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Recommended workaround: ",e.jsx(s,{href:"#ssr-noexternal"}),"."]}),`
`,e.jsx("h3",{id:"err-unknown-file-extension-css",children:"ERR_UNKNOWN_FILE_EXTENSION .css"}),`
`,e.jsx(n.p,{children:"Another common problem is code importing CSS which makes Node.js crash:"}),`
...
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// node_modules/some-good-lib/dist/index.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
