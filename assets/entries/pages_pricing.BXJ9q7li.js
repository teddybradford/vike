import{j as e,a as t,L as k,o as S,i as v}from"../chunks/chunk-C75gEwxg.js";import{L as p}from"../chunks/chunk-Qa7bTfM6.js";/* empty css                      */import{a as T}from"../chunks/chunk-DkAUbMip.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DWElet6Q.js";import{O as P}from"../chunks/chunk-BlWj60M9.js";/* empty css                      *//* empty css                      *//* empty css                      */const m="#a00",g="#0a0",C="#e90";function d(){return e.jsx(e.Fragment,{children:" |"})}function O(){return e.jsx("span",{style:{color:g,fontSize:"1.9em",display:"block"},children:"✓"})}function F(){return e.jsx("span",{style:{color:m,fontSize:"1.6em",display:"block"},children:"✗"})}function V({value:s}){const u=x(),i=D(s);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:u,backgroundColor:i,borderRadius:10}})});function x(){return t(s>0&&s<100),"calc("+s/100+" * 100%)"}}function D(s){return t(s>0&&s<100),s<50?m:s>=75?g:C}function h({name:s,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:s}),": ",n]})}function L({entries:s,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(i,{children:""}),e.jsx(i,{children:"Trans­parent"}),e.jsx(i,{children:"Fork­able"}),e.jsx(i,{children:"Access­ible"}),e.jsx(i,{children:"Sustai­nable"}),e.jsx(i,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:s.map((r,a)=>e.jsx(u,{...r},a))})]})});function u({modelName:r,transparent:a,forkable:c,accessible:j,independent:b,sustainable:w}){return e.jsxs("tr",{children:[e.jsx(o,{children:r}),e.jsx(o,{children:e.jsx(l,{val:a})}),e.jsx(o,{children:e.jsx(l,{val:c})}),e.jsx(o,{children:e.jsx(l,{val:j})}),e.jsx(o,{children:e.jsx(l,{val:w})}),e.jsx(o,{children:e.jsx(l,{val:b})})]})}function i({children:r,...a}){if(t(Object.keys(a).length===0),!r)return e.jsx("th",{});const c=r,j=n?c:e.jsx("a",{href:x(c),children:c});return e.jsx("th",{align:"center",children:j})}function x(r){return t(r.constructor===String),t(!r.includes("&shy;"),{value_name:r}),t(!r.includes("%C2%AD"),{value_name:r}),"/values"}function o({children:r}){return e.jsx("td",{align:"center",children:r})}function l({val:r}){return t(0<=r&&r<=1),r===1?e.jsx(O,{}):r===0?e.jsx(F,{}):e.jsx(V,{value:r*100})}}function N(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function f(s){const n={li:"li",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(L,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(d,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(d,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(d,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(d,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(d,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
...
`,e.jsx("br",{}),`
`,e.jsx(p,{doNotInferSectionTitle:!0,href:"#how-does-it-work"}),`
`,e.jsx("br",{}),`
`,e.jsx(p,{doNotInferSectionTitle:!0,href:"#do-sponsors-have-to-pay"}),`
`,e.jsx("br",{}),`
`,e.jsx(p,{doNotInferSectionTitle:!0,href:"#is-vike-still-free-software"}),`
`,e.jsx("br",{}),`
`,e.jsx(p,{doNotInferSectionTitle:!0,href:"#why-not-another-business-model"}),`
`,e.jsx("br",{}),`
...
`,e.jsx(n.p,{children:"No, Vike stays free for companies sponsoring Vike (Bronze, Silver, Gold, and Platinum). Reach out and we will give you a free license key."}),`
`,e.jsx("h3",{id:"is-vike-still-free-software",children:"Is Vike still Free Software?"}),`
`,e.jsxs(n.p,{children:['Vike is still free as in "free speech" (not as in free beer), as ',e.jsx(n.a,{href:"https://www.gnu.org/philosophy/free-sw.en.html",children:"explained by the Free Software Foundation"})," and ",e.jsx(n.a,{href:"https://en.wikipedia.org/wiki/Free_software",children:"by Wikipedia"}),"."]}),`
`,e.jsx(n.p,{children:"We are passionate about Libre Software and that's, precisely, why we invented the Open Source Pricing. Code remains not only 100% open source but also 100% accessible: money (and the lack thereof) should never be a showstopper for using code."}),`
