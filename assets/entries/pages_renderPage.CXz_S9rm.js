import{j as e,b as r,L as o,o as i,i as t}from"../chunks/chunk-T3m8bCCg.js";import{L as n}from"../chunks/chunk-Dg6x-qHX.js";/* empty css                      *//* empty css                      *//* empty css                      */import{M as d}from"../chunks/chunk-CeYihGWU.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */const c=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"usage",pageSectionLevel:2,pageSectionTitle:"Usage"},{pageSectionId:"optional",pageSectionLevel:2,pageSectionTitle:"Optional"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Environment: server."}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Upon development, Vike automatically embeds itself into Vite's development server (",e.jsx(s.code,{children:"$ vite"}),"/",e.jsx(s.code,{children:"$ vite dev"}),")."]}),`
`,e.jsxs(s.li,{children:["Upon pre-rendering (",e.jsx(s.code,{children:"$ vite build"}),"/",e.jsx(s.code,{children:"$ vike prerender"}),") Vike renders all your pages."]}),`
`]}),`
