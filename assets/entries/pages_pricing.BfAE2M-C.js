import{j as e,a as o,L as k,o as v,i as S}from"../chunks/chunk-B4V7wIR1.js";import{L as t}from"../chunks/chunk-DWcoZmvA.js";/* empty css                      */import{a as T}from"../chunks/chunk-DFIQUb2j.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BdLdLbhk.js";import{O as P}from"../chunks/chunk-DSGPjcOd.js";/* empty css                      *//* empty css                      *//* empty css                      */const m="#a00",g="#0a0",C="#e90";function h(){return e.jsx(e.Fragment,{children:" |"})}function O(){return e.jsx("span",{style:{color:g,fontSize:"1.9em",display:"block"},children:"✓"})}function V(){return e.jsx("span",{style:{color:m,fontSize:"1.6em",display:"block"},children:"✗"})}function I({value:s}){const u=x(),r=F(s);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:u,backgroundColor:r,borderRadius:10}})});function x(){return o(s>0&&s<100),"calc("+s/100+" * 100%)"}}function F(s){return o(s>0&&s<100),s<50?m:s>=75?g:C}function p({name:s,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:s}),": ",n]})}function z({entries:s,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(r,{children:""}),e.jsx(r,{children:"Trans­parent"}),e.jsx(r,{children:"Fork­able"}),e.jsx(r,{children:"Access­ible"}),e.jsx(r,{children:"Sustai­nable"}),e.jsx(r,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:s.map((i,l)=>e.jsx(u,{...i},l))})]})});function u({modelName:i,transparent:l,forkable:d,accessible:j,independent:b,sustainable:w}){return e.jsxs("tr",{children:[e.jsx(a,{children:i}),e.jsx(a,{children:e.jsx(c,{val:l})}),e.jsx(a,{children:e.jsx(c,{val:d})}),e.jsx(a,{children:e.jsx(c,{val:j})}),e.jsx(a,{children:e.jsx(c,{val:w})}),e.jsx(a,{children:e.jsx(c,{val:b})})]})}function r({children:i,...l}){if(o(Object.keys(l).length===0),!i)return e.jsx("th",{});const d=i,j=n?d:e.jsx("a",{href:x(d),children:d});return e.jsx("th",{align:"center",children:j})}function x(i){return o(i.constructor===String),o(!i.includes("&shy;"),{value_name:i}),o(!i.includes("%C2%AD"),{value_name:i}),"/values"}function a({children:i}){return e.jsx("td",{align:"center",children:i})}function c({val:i}){return o(0<=i&&i<=1),i===1?e.jsx(O,{}):i===0?e.jsx(V,{}):e.jsx(I,{value:i*100})}}function L(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function y(s){const n={li:"li",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(z,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
