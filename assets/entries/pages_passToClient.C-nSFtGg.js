import{j as e,i as r,L as i,o}from"../chunks/chunk-CFmyzty0.js";import{L as s}from"../chunks/chunk-u01haEzF.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B9CqHOdX.js";/* empty css                      */const t=[{pageSectionId:"default",pageSectionLevel:2,pageSectionTitle:"Default"},{pageSectionId:"serialization",pageSectionLevel:2,pageSectionTitle:"Serialization"},{pageSectionId:"escape",pageSectionLevel:2,pageSectionTitle:"Escape"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Most ",e.jsx(s,{href:"/pageContext",children:e.jsx(n.code,{children:"pageContext"})})," values are available only on the server-side, but you can use ",e.jsx(n.code,{children:"passToClient"})," to make values available on the client-side."]}),`
...
`,e.jsxs(n.span,{"data-line":"",children:[e.jsx(n.span,{style:{color:"#032F62"},children:"    'user.info.avatar.url'"}),e.jsx(n.span,{style:{color:"#24292E"},children:", "}),e.jsx(n.span,{style:{color:"#6A737D"},children:"// Deeply nested"})]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  // pageContext.user.id is available here thanks to passToClient"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(n.p,{children:["Some values, such as ",e.jsx(n.code,{children:"pageContext.data"}),", are already passed to the client-side ",e.jsx(s,{href:"#default",children:"by default"}),"."]}),`
`,e.jsxs(n.p,{children:["The nesting ",e.jsxs(s,{href:"#escape",children:["delimiter ",e.jsx(n.code,{children:"."})," can be escaped"]}),"."]}),`
...
`,e.jsx("h2",{id:"escape",children:"Escape"}),`
`,e.jsxs(n.p,{children:["In the (unlikely) case you need to pass properties that include ",e.jsx(n.code,{children:"."})," in their name:"]}),`
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// /pages/+config.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// Environment: config"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
`,e.jsxs(n.span,{"data-line":"",children:[e.jsx(n.span,{style:{color:"#D73A49"},children:"export"}),e.jsx(n.span,{style:{color:"#D73A49"},children:" default"}),e.jsx(n.span,{style:{color:"#24292E"},children:" {"})]}),`
