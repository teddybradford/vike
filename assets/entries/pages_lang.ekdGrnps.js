import{j as e,i as r,L as o,o as i}from"../chunks/chunk-DGwgoGLd.js";import{L as s}from"../chunks/chunk-cXnLVFUg.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B_fVIwSZ.js";import{U as t}from"../chunks/chunk-Dm9a2T5G.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Type: ",e.jsx(n.code,{children:"string | null | ((pageContext) => string | null | undefined)"}),e.jsx(n.br,{}),`
