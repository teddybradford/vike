...
`,e.jsxs(n.p,{children:["For example, in the following, it only applies to ",e.jsx(n.code,{children:"my-app/"})," and ",e.jsx(n.code,{children:"my-other-app/"}),"."]}),`
