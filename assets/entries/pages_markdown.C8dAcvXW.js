...
`,e.jsxs(n.p,{children:["A simple way to define metadata is to define a ",e.jsx(n.code,{children:"metadata.js"})," file that contains ",e.jsx(s,{href:"#metadata:~:text=frontmatter-,Global%20metadata,-What",children:"global metadata"}),"."]}),`
...
`,e.jsxs(n.p,{children:["You can use ",e.jsx(s,{href:"/meta",children:e.jsx(n.code,{children:"meta"})})," to create custom settings for defining ",e.jsx(s,{href:"#metadata:~:text=.-,Local%20metadata,-What",children:"local metadata"}),"."]}),`
