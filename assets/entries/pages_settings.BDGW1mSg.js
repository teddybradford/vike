import{j as e,o as l,i as d}from"../chunks/chunk-QQHFLgus.js";import{L as s}from"../chunks/chunk-DJTIoNMK.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-7E_FEcaS.js";/* empty css                      */function i({children:r}){return e.jsx("span",{style:{opacity:.85,fontSize:"0.9em",verticalAlign:"middle"},children:e.jsx("code",{children:r})})}const o=[{pageSectionId:"basic",pageSectionLevel:2,pageSectionTitle:"Basic"},{pageSectionId:"html",pageSectionLevel:3,pageSectionTitle:"HTML"},{pageSectionId:"advanced",pageSectionLevel:2,pageSectionTitle:"Advanced"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(r){const n={a:"a",blockquote:"blockquote",code:"code",li:"li",p:"p",strong:"strong",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["List of built-in settings. (You can ",e.jsx(s,{href:"/meta",children:"create your own settings"}),".)"]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/prerender",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"prerender"})})}),": Whether to ",e.jsx(s,{href:"/pre-rendering",children:"pre-render"})," the page, and pre-rendering settings."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/extends",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"extends"})})}),": Install ",e.jsx(s,{href:"/extensions"}),"."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["You create your own custom HTML settings, see ",e.jsx(s,{href:"/head-tags#custom-settings"}),"."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/clientRouting",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"clientRouting"})})}),": ",e.jsx(i,{children:"boolean"})," Enable ",e.jsx(s,{href:"/client-routing",children:"Client Routing"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/hydrationCanBeAborted",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"hydrationCanBeAborted"})})}),": ",e.jsx(i,{children:"boolean"}),"  Whether your ",e.jsx(s,{text:"UI framework",href:"/ui-frameworks"})," allows the ",e.jsx(s,{href:"/hydration",children:"hydration"})," to be aborted."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/filesystemRoutingRoot",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"filesystemRoutingRoot"})})}),": URL root for ",e.jsx(s,{href:"/filesystem-routing",children:"Filesystem Routing"}),"."]}),`
