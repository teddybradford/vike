import{j as e,b as r,L as o,o as c}from"../chunks/chunk-BDl3L7LG.js";import{L as l}from"../chunks/chunk-C57YDwx2.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */const t=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"pre-rendering",pageSectionLevel:2,pageSectionTitle:"Pre-rendering"},{pageSectionId:"lang",pageSectionLevel:2,pageSectionTitle:"`lang`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(s){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["You can internationalize (i18n) your app by using the ",e.jsx(l,{text:e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"onBeforeRoute()"})," hook"]}),href:"/onBeforeRoute"}),"."]}),`
`,e.jsx(n.p,{children:"For example:"}),`
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// /renderer/+onBeforeRoute.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
`,e.jsxs(n.span,{"data-line":"",children:[e.jsx(n.span,{style:{color:"#D73A49"},children:"export"}),e.jsx(n.span,{style:{color:"#24292E"},children:" { onBeforeRoute }"})]}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"      // Vike's router will use pageContext.urlLogical instead of pageContext.urlOriginal"})}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Upon rendering a page, ",e.jsx(n.code,{children:"onBeforeRoute()"})," is the first hook that Vike calls, which means that the rest of your app doesn't have to deal with localized URLs anymore and you can simply use ",e.jsx(n.code,{children:"pageContext.locale"})," instead."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["See ",e.jsx(l,{href:"/usePageContext"})," for being able to access ",e.jsx(n.code,{children:"pageContext.locale"})," in any React/Vue component."]}),`
`]}),`
`,e.jsx(n.p,{children:"This technique also works with:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"?lang=fr"})," query parameters"]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"domain.fr"})," domain TLDs"]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"Accept-Language: fr-FR"})," headers"]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"Accept-Language"})," header can be used for redirecting the user to the right localized URL (e.g. URL ",e.jsx(n.code,{children:"/about"})," + Header ",e.jsx(n.code,{children:"Accept-Language: de-DE"})," => redirect to ",e.jsx(n.code,{children:"/de-DE/about"}),"). Once the user is redirected to a localized URL, you can use the technique described above. You can perform the redirection by using your server (e.g. Express.js) independently of Vike."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Using the ",e.jsx(n.code,{children:"Accept-Language"})," header to show different languages for the same URL is considered bad practice for both SEO and UX reasons. It's recommended to use ",e.jsx(n.code,{children:"Accept-Language"})," only to redirect the user."]}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// /renderer/+onPrerenderStart.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
...
`]}),`
`]})]})}function i(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}const d=Object.freeze(Object.defineProperty({__proto__:null,default:i,pageSectionsExport:t},Symbol.toStringTag,{value:"Module"})),D={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},Layout:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/Layout",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:o}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:c}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/i18n/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:d}}};export{D as configValuesSerialized};
