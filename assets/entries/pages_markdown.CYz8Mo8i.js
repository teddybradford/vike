...
`]}),`
`]}),`
`,e.jsx(o,{children:e.jsxs(n.p,{children:["You may be tempted to use ",e.jsx(n.a,{href:"https://vitejs.dev/guide/features.html#glob-import",children:e.jsx(n.code,{children:"import.meta.glob()"})})," to retrieve the metadata of all your pages, but we discourage this approach: loading all markdown files at once ",e.jsx(d,{}),"."]})}),`
