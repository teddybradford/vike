import{j as e,i,L as t,o as c}from"../chunks/chunk-CG41MbHj.js";import{L as n}from"../chunks/chunk-QmgkQm-c.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-C2leeDPr.js";import{T as d,a as p,b as r,c as a}from"../chunks/chunk-DhtbkLzG.js";/* empty css                      *//* empty css                      */const h=[{pageSectionId:"zero-config",pageSectionLevel:2,pageSectionTitle:"Zero-config"},{pageSectionId:"hmr",pageSectionLevel:2,pageSectionTitle:"HMR"},{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"releasing-1-0",pageSectionLevel:2,pageSectionTitle:"Releasing `1.0`"},{pageSectionId:"vite-s-environment-api",pageSectionLevel:2,pageSectionTitle:"Vite's Environment API"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(l){const s={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["We (",e.jsx(n,{href:"/team",children:"Joël, Dani, and Rom"}),") are beyond thrilled to announce a ",e.jsxs(n,{href:"/server",children:["new Vike extension ",e.jsx(s.code,{children:"vike-server"})]})," that can integrate Vite with any server (Express.js, Hono, Fastify, Elysia, H3, ...) and any deployment (VPS, Netlify, Cloudflare, Vercel, ...)."]}),`
...
`,e.jsxs(s.p,{children:["Using Vite to transpile server code was one of the most requested features (unsurprisingly so). In fact, we considered this Vike's last significant shortcoming: Vike can now be considered a state-of-the-art and full-fledged framework and we're now a lot ",e.jsxs(n,{href:"#releasing-1-0",children:["closer to releasing ",e.jsx(s.code,{children:"1.0"})]}),"!"]}),`
`]}),`
