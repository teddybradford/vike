import{j as e,L as r,o as a,i as o}from"../chunks/chunk-CGuDyapq.js";import{L as l}from"../chunks/chunk-iJWCupAE.js";/* empty css                      */import{M as i}from"../chunks/chunk-DBO7A6UA.js";import{I as d}from"../chunks/chunk-B5mZPHuY.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-Be-9ij3x.js";/* empty css                      */import"../chunks/chunk-msZsbzd5.js";/* empty css                      */const c=[{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"under-the-hood",pageSectionLevel:2,pageSectionTitle:"Under the hood"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(n){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Type: ",e.jsx(s.code,{children:"string | null | ((pageContext) => string | null | undefined)"}),e.jsx(s.br,{}),`
`,"Kind: overridable.",e.jsx(s.br,{}),`
`,"Environment: server."]}),`
`,e.jsx(d,{noCustomGuide:!0}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["See ",e.jsx(l,{href:"/head-tags"})," for a general introduction about ",e.jsx(s.code,{children:"<head>"})," tags."]}),`
`]}),`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"image"})," setting sets the ",e.jsx(s.a,{href:"https://ahrefs.com/blog/open-graph-meta-tags/#:~:text=8%20simple%20steps.%22%20/%3E-,%3Cmeta%20property%3D%22og%3Aimage%22,-content%3D%22https%3A//ahrefs",children:"preview image upon URL sharing"}),"."]}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"  image: previewImage"})}),`
...
`,e.jsxs(s.li,{children:[e.jsx(l,{href:"/head-tags#page-specific"})," you can override it."]}),`
`,e.jsxs(s.li,{children:[e.jsx(l,{href:"/head-tags#data"})," you can set it based on fetched data."]}),`
`]}),`
`,e.jsx("h2",{id:"typescript",children:"TypeScript"}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"tsx","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"tsx","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// pages/some-page/+image.js"})}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"  return"}),e.jsx(s.span,{style:{color:"#24292E"},children:" pageContext.data.product.image"})]}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx("h2",{id:"under-the-hood",children:"Under the hood"}),`
`,e.jsx(i,{}),`
`,e.jsx("h2",{id:"see-also",children:"See also"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://ahrefs.com/blog/open-graph-meta-tags/",children:"Ahrefs > Blog > Open Graph Meta Tags: Everything You Need to Know"})}),`
