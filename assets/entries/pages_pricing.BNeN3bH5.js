import{j as e,a as t,L as k,o as v,i as S}from"../chunks/chunk-B4V7wIR1.js";import{L as l}from"../chunks/chunk-DWcoZmvA.js";/* empty css                      */import{a as T}from"../chunks/chunk-DFIQUb2j.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BdLdLbhk.js";import{O as P}from"../chunks/chunk-DSGPjcOd.js";/* empty css                      *//* empty css                      *//* empty css                      */const m="#a00",g="#0a0",C="#e90";function h(){return e.jsx(e.Fragment,{children:" |"})}function O(){return e.jsx("span",{style:{color:g,fontSize:"1.9em",display:"block"},children:"✓"})}function V(){return e.jsx("span",{style:{color:m,fontSize:"1.6em",display:"block"},children:"✗"})}function F({value:s}){const u=x(),r=I(s);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:u,backgroundColor:r,borderRadius:10}})});function x(){return t(s>0&&s<100),"calc("+s/100+" * 100%)"}}function I(s){return t(s>0&&s<100),s<50?m:s>=75?g:C}function p({name:s,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:s}),": ",n]})}function z({entries:s,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(r,{children:""}),e.jsx(r,{children:"Trans­parent"}),e.jsx(r,{children:"Fork­able"}),e.jsx(r,{children:"Access­ible"}),e.jsx(r,{children:"Sustai­nable"}),e.jsx(r,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:s.map((i,a)=>e.jsx(u,{...i},a))})]})});function u({modelName:i,transparent:a,forkable:d,accessible:j,independent:b,sustainable:w}){return e.jsxs("tr",{children:[e.jsx(o,{children:i}),e.jsx(o,{children:e.jsx(c,{val:a})}),e.jsx(o,{children:e.jsx(c,{val:d})}),e.jsx(o,{children:e.jsx(c,{val:j})}),e.jsx(o,{children:e.jsx(c,{val:w})}),e.jsx(o,{children:e.jsx(c,{val:b})})]})}function r({children:i,...a}){if(t(Object.keys(a).length===0),!i)return e.jsx("th",{});const d=i,j=n?d:e.jsx("a",{href:x(d),children:d});return e.jsx("th",{align:"center",children:j})}function x(i){return t(i.constructor===String),t(!i.includes("&shy;"),{value_name:i}),t(!i.includes("%C2%AD"),{value_name:i}),"/values"}function o({children:i}){return e.jsx("td",{align:"center",children:i})}function c({val:i}){return t(0<=i&&i<=1),i===1?e.jsx(O,{}):i===0?e.jsx(V,{}):e.jsx(F,{value:i*100})}}function L(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function y(s){const n={li:"li",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(z,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
...
`]}),`
`]})]})}function A(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(y,{...s})}):y(s)}const D=[{pageSectionId:"how-does-it-work",pageSectionLevel:3,pageSectionTitle:"How does it work?"},{pageSectionId:"what-is-considered-a-small-app-vs-a-larger-app",pageSectionLevel:3,pageSectionTitle:'What is considered a "small app" vs a "larger app"?'},{pageSectionId:"do-sponsors-have-to-pay",pageSectionLevel:3,pageSectionTitle:"Do sponsors have to pay?"},{pageSectionId:"why-zero-investors",pageSectionLevel:3,pageSectionTitle:"Why zero investors?"},{pageSectionId:"is-vike-still-free-software",pageSectionLevel:3,pageSectionTitle:"Is Vike still Free Software?"},{pageSectionId:"why-not-another-business-model",pageSectionLevel:3,pageSectionTitle:"Why not another business model?"}];function f(s){const n={a:"a",code:"code",em:"em",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(T,{children:"The Open Source Pricing isn't implemented yet."}),`
...
`,e.jsx("br",{}),`
`,e.jsx(l,{doNotInferSectionTitle:!0,href:"#how-does-it-work"}),`
`,e.jsx("br",{}),`
`,e.jsx(l,{doNotInferSectionTitle:!0,href:"#do-sponsors-have-to-pay"}),`
`,e.jsx("br",{}),`
`,e.jsx(l,{doNotInferSectionTitle:!0,href:"#why-zero-investors"}),`
`,e.jsx("br",{}),`
`,e.jsx(l,{doNotInferSectionTitle:!0,href:"#is-vike-still-free-software"}),`
`,e.jsx("br",{}),`
`,e.jsx(l,{doNotInferSectionTitle:!0,href:"#why-not-another-business-model"}),`
`,e.jsx("br",{}),`
...
`,e.jsx("h3",{id:"what-is-considered-a-small-app-vs-a-larger-app",children:'What is considered a "small app" vs a "larger app"?'}),`
`,e.jsx(n.p,{children:"Vike will use multiple heuristics to reliably determine whether your app is:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"A small-ish or new-ish project"}),`
`,e.jsx(n.li,{children:"A large project implementing a big and ambitious app"}),`
`]}),`
`,e.jsx(n.p,{children:"There isn't any clear cut, and the heuristic is subject to be changed."}),`
`,e.jsx(n.p,{children:`You can think of it like this: as long as Vike considers your app "small", you are within the free trial and you don't need any license key (you can use Vike just like any other open source tool). If you see the pesky toaster then you need a license key to remove it: you can either purchase or apply for a free one.`}),`
`,e.jsx(n.p,{children:"We will be generous as to what we consider small enough to be part of the free trial."}),`
...
`,e.jsxs(n.p,{children:["We believe in Libre Software and we invented the Open Source Pricing because ",e.jsx(l,{doNotInferSectionTitle:!0,href:"#why-not-another-business-model",children:"other business models contradict Libre Software values"}),"."]}),`
