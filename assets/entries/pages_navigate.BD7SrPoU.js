...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"navigate('/some-url', { keepScrollPosition: true })"}),": Don't scroll to the top of the page, preserve the scroll position instead. See also ",e.jsx(s,{href:"/clientRouting#settings",children:e.jsx(n.code,{children:'<a href="/some-url" keep-scroll-position />'})}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"navigate('/some-url', { overwriteLastHistoryEntry: true })"}),": Don't create a new entry in the browser's history, instead let the new URL replace the current URL. This effectively removes the current URL from the browser history."]}),`
`]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  /* Same as:"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  const { triggeredBy } = event.state"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"  }"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  // Navigation triggered by your history.pushState() call"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"    // Implement your navigation handling here"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"  }"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"})"})})]})})}),`
