import{j as e,i as o,L as t,o as d}from"../chunks/chunk-h3bYPDVF.js";import{L as n}from"../chunks/chunk-Ykj57Jia.js";/* empty css                      */import{W as c}from"../chunks/chunk-BHuVOxQI.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DPVKd4q0.js";import{T as p,a as h,b as r,c as a}from"../chunks/chunk-BZdRe_ct.js";/* empty css                      *//* empty css                      *//* empty css                      */const x=[{pageSectionId:"add-vike-server-to-an-existing-vike-app",pageSectionLevel:2,pageSectionTitle:"Add `vike-server` to an existing Vike app"},{pageSectionId:"deployment",pageSectionLevel:2,pageSectionTitle:"Deployment"},{pageSectionId:"custom-pagecontext",pageSectionLevel:2,pageSectionTitle:"Custom `pageContext`"},{pageSectionId:"serve-options",pageSectionLevel:2,pageSectionTitle:"`serve()` options"},{pageSectionId:"standalone",pageSectionLevel:2,pageSectionTitle:"Standalone"},{pageSectionId:"hmr",pageSectionLevel:2,pageSectionTitle:"HMR"},{pageSectionId:"compression",pageSectionLevel:2,pageSectionTitle:"Compression"},{pageSectionId:"https",pageSectionLevel:2,pageSectionTitle:"HTTPS"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["To integrate Vike with your server we recommend using ",e.jsx(s.code,{children:"vike-server"})," which comes with many benefits such as:"]}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["The ",e.jsx(s.code,{children:"port"})," option is only used when running on non-serverless environments."]}),`
`,e.jsx(s.li,{children:"All other options are passed down as-is to the target environment."}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"serve()"})," helper can further be configured with the following options:"]}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"  // [Required] Server port"})}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"    //   node:  Server ('node:http') by default,"})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"    //          could be an HTTPS or HTTP2 server if `createServer` is provided (see below)"})}),`
...
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"    // As no server is running under serverless environments like Cloudflare or Vercel Edge,"})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"    // `server` is `undefined` in those runtimes."})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"  },"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"  // ⚠️  The following options are available when running on Node only!"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"  //     import { createSecureServer } from 'node:http2'"})}),`
...
`,e.jsx(c,{children:e.jsx(s.p,{children:"This feature is experimental and may break upon any version update."})}),`
`,e.jsxs(s.blockquote,{children:[`
