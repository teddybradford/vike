...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:e.jsx(n.code,{children:"pageContext.isClientSide"})}),": Whether the page is being rendered on the client-side, or rendered on the server-side / ",e.jsx(s,{href:"/pre-rendering",children:"pre-rendered"}),". It's equivalent to: ",e.jsx("code",{children:"pageContext.isClientSide !== import.meta.env.SSR"}),"."]}),`
`,e.jsxs(o,{children:[e.jsxs(n.p,{children:["We recommend using ",e.jsxs(n.a,{href:"https://vite.dev/guide/env-and-mode.html#built-in-constants",children:["Vite's ",e.jsx(n.code,{children:"import.meta.env.SSR"})]})," whenever possible instead. Because Vite eliminates any code defined inside ",e.jsx(n.code,{children:"import.meta.env.SSR"})," blocks from client-side bundles, saving potentially a ",e.jsx(n.em,{children:"lot"})," of KBs. This isn't the case with ",e.jsx(n.code,{children:"pageContext.isClientSide"}),"."]}),e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// This import is also removed if it's used only inside import.meta.env.SSR code blocks"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  // ... server-side code ..."})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})})]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"pageContext"})," object is tied to the rendering of a page — whenever a page is (re-)rendered, a new ",e.jsx(n.code,{children:"pageContext"})," object is created."]}),`
`,e.jsxs(n.p,{children:["The lifecycle of the ",e.jsx(n.code,{children:"pageContext"})," object is fairly straightforward and predictable on the client and server, but for pre-rendered pages ",e.jsxs(s,{href:"#pre-rendering",children:["it can be surprising (some ",e.jsx(n.code,{children:"pageContext"}),' properties may seem "outdated")']}),"."]}),`
