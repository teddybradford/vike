import{j as e,L as r,o,i}from"../chunks/chunk-BciMMxMm.js";import{L as s}from"../chunks/chunk-BqURl_th.js";/* empty css                      *//* empty css                      *//* empty css                      */import{U as t}from"../chunks/chunk-BSZItvnN.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-Dg62CnJB.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Type: ",e.jsx(n.code,{children:"string | null | ((pageContext) => string | null | undefined)"}),e.jsx(n.br,{}),`
