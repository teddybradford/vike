import{j as e,L as t,o as i}from"../chunks/chunk-BDl3L7LG.js";import{L as n}from"../chunks/chunk-C57YDwx2.js";/* empty css                      *//* empty css                      *//* empty css                      */import{U as r}from"../chunks/chunk-BqRrYk9k.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */const o=[{pageSectionId:"orm-sql",pageSectionLevel:2,pageSectionTitle:"ORM/SQL"},{pageSectionId:"error-handling",pageSectionLevel:2,pageSectionTitle:"Error handling"},{pageSectionId:"environment",pageSectionLevel:2,pageSectionTitle:"Environment"},{pageSectionId:"client-side-only",pageSectionLevel:3,pageSectionTitle:"Client-side only"},{pageSectionId:"server-and-client-side",pageSectionLevel:3,pageSectionTitle:"Server- and client-side"},{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const s={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Environment: server (",e.jsx(n,{href:"#environment",children:"configurable"}),")."]}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-react/pages/star-wars/index/+data.js"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-react/pages/star-wars/index/+Page.jsx"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-react/pages/star-wars/@id/+data.js"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-react/pages/star-wars/@id/+Page.jsx"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`]}),`
`,e.jsx(s.p,{children:"React + TypeScript:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-react-ts/pages/star-wars/index/+data.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-react-ts/pages/star-wars/index/+Page.tsx"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-react-ts/pages/star-wars/@id/+data.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-react-ts/pages/star-wars/@id/+Page.tsx"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`]}),`
`,e.jsx(s.p,{children:"Vue + JavaScript:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-vue/pages/star-wars/index/+data.js"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-vue/pages/star-wars/index/+Page.vue"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-vue/pages/star-wars/@id/+data.js"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-vue/pages/star-wars/@id/+Page.vue"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`]}),`
`,e.jsx(s.p,{children:"Vue + TypeScript:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-vue-ts/pages/star-wars/index/+data.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-vue-ts/pages/star-wars/index/+Page.vue"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(n,{href:"/boilerplates/boilerplate-vue-ts/pages/star-wars/@id/+data.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-vue-ts/pages/star-wars/@id/+Page.vue"})," (",e.jsx(s.code,{children:"useData()"})," usage)"]}),`
`]}),`
...
`]}),`
`]})]})}function d(l={}){const{wrapper:s}=l.components||{};return s?e.jsx(s,{...l,children:e.jsx(a,{...l})}):a(l)}const c=Object.freeze(Object.defineProperty({__proto__:null,default:d,pageSectionsExport:o},Symbol.toStringTag,{value:"Module"})),E={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},Layout:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/Layout",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:t}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:i}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/data/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:c}}};export{E as configValuesSerialized};
