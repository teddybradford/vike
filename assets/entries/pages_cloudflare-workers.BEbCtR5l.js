...
`,e.jsxs(r.p,{children:["You can also use ",e.jsx(r.a,{href:"https://github.com/Aslemammad/vite-plugin-cloudflare",children:"vite-plugin-cloudflare"})," which enables you to simply use ",e.jsx(r.code,{children:"$ vite build"})," and ",e.jsx(r.code,{children:"$ vite dev"})," to build and develop your worker code (including HMR support!)."]}),`
