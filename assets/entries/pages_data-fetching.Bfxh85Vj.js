...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["These extensions enable any of your components, including your ",e.jsxs(s,{href:"/Layout",children:[e.jsx(n.code,{children:"<Layout>"})," components"]}),", to fetch data."]}),`
`]}),`
