import{j as e,L as i,o as r}from"../chunks/chunk-BDl3L7LG.js";import{L as l}from"../chunks/chunk-C57YDwx2.js";/* empty css                      *//* empty css                      *//* empty css                      */import{U as t}from"../chunks/chunk-BqRrYk9k.js";import{I as o}from"../chunks/chunk-CFYQxlJp.js";/* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(s){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Default value: ",e.jsx(n.code,{children:"true"}),"."]}),`
...
`,e.jsxs(n.li,{children:["You can use ",e.jsx(l,{href:"/clientOnly",children:e.jsx(n.code,{children:"clientOnly()"})})," to render and load some components only on the client-side while rendering the rest of the page with SSR."]}),`
`,e.jsxs(n.li,{children:["You can ",e.jsx(l,{href:"/pre-rendering",children:"pre-render"})," some of (or all) your pages."]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["For an improved file and config organization, you can consider using a ",e.jsx(l,{href:"/file-structure#domain-driven",children:"domain-driven file structure"}),"."]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["See also ",e.jsx(l,{href:"/render-modes"}),"."]}),`
