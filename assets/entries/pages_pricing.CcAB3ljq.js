import{j as e,a as c,i as C,L as z,o as V}from"../chunks/chunk-Cj1Izk7l.js";import{L as o}from"../chunks/chunk-DnmNhQkf.js";/* empty css                      */import{a as L}from"../chunks/chunk-D0tOf5VI.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CixVi6FN.js";import{O}from"../chunks/chunk-7j5OQDDi.js";/* empty css                      *//* empty css                      *//* empty css                      */const v="#a00",T="#0a0",P="#e90";function x(){return e.jsx(e.Fragment,{children:" |"})}function A(){return e.jsx("span",{style:{color:T,fontSize:"1.9em",display:"block"},children:"✓"})}function R(){return e.jsx("span",{style:{color:v,fontSize:"1.6em",display:"block"},children:"✗"})}function N({value:i}){const t=p(),r=$(i);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:t,backgroundColor:r,borderRadius:10}})});function p(){return c(i>0&&i<100),"calc("+i/100+" * 100%)"}}function $(i){return c(i>0&&i<100),i<50?v:i>=75?T:P}function j({name:i,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:i}),": ",n]})}function D({entries:i,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(r,{children:""}),e.jsx(r,{children:"Trans­parent"}),e.jsx(r,{children:"Fork­able"}),e.jsx(r,{children:"Access­ible"}),e.jsx(r,{children:"Sustai­nable"}),e.jsx(r,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:i.map((s,d)=>e.jsx(t,{...s},d))})]})});function t({modelName:s,transparent:d,forkable:u,accessible:y,independent:F,sustainable:I}){return e.jsxs("tr",{children:[e.jsx(a,{children:s}),e.jsx(a,{children:e.jsx(l,{val:d})}),e.jsx(a,{children:e.jsx(l,{val:u})}),e.jsx(a,{children:e.jsx(l,{val:y})}),e.jsx(a,{children:e.jsx(l,{val:I})}),e.jsx(a,{children:e.jsx(l,{val:F})})]})}function r({children:s,...d}){if(c(Object.keys(d).length===0),!s)return e.jsx("th",{});const u=s,y=n?u:e.jsx("a",{href:p(u),children:u});return e.jsx("th",{align:"center",children:y})}function p(s){return c(s.constructor===String),c(!s.includes("&shy;"),{value_name:s}),c(!s.includes("%C2%AD"),{value_name:s}),"/values"}function a({children:s}){return e.jsx("td",{align:"center",children:s})}function l({val:s}){return c(0<=s&&s<=1),s===1?e.jsx(A,{}):s===0?e.jsx(R,{}):e.jsx(N,{value:s*100})}}function _(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function f(i){const n={li:"li",p:"p",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(D,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(x,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(x,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(x,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(x,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(x,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
`,e.jsx(n.p,{children:"Values:"}),`
`,e.jsx(_,{}),`
`,e.jsx(n.p,{children:"Business Models:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(j,{name:"Open Source | Donations",children:"some projects, due to their very high number of users and low developing cost, can sustain solely on donations."}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(j,{name:"Open Source | Company Backed",children:"a company open sourcing some of its internal tool."}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(j,{name:"Open Source | Open Core",children:"the code is open source but some extensions/features are proprietary."}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(j,{name:"Proprietary | Public Source",children:"proprietary but the code is publicly available to be read."}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(j,{name:"Proprietary | Closed Source",children:"closed sourced, not forkable, usually expensive."}),`
`]}),`
`]})]})}function E(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(f,{...i})}):f(i)}const h={table:{borderCollapse:"collapse",width:"100%",maxWidth:"600px",textAlign:"center",fontFamily:"Arial, sans-serif",border:"1px solid #ddd"},cell:{padding:"15px 30px",border:"1px solid #ddd",fontSize:"16px"},subtext:{fontSize:"12px",fontWeight:"normal",color:"#6b7280"},priceContainer:{display:"flex",alignItems:"baseline",whiteSpace:"nowrap",justifyContent:"center",gap:"5px"},priceSubtext:{fontSize:"13px",color:"#6b7280"},recommendation:{fontSize:"12px",color:"#666",marginTop:"2px"}},b=[["1$ - 50$","1$ - 100$","1$ - 200$"],["50$ - 100$","100$ - 200$","200$ - 500$"],["100$ - 200$","200$ - 500$","500$ - 2000$"]],w=["Small organization","Midsize organization","Large organization"],g=["≤2 regular committers","Hobby use case"],M=["Small use case","Midsize use case","Large use case"],m=g.concat(M);function W(){return e.jsx("table",{style:h.table,children:e.jsx("tbody",{children:S(m.length+1).map(i=>e.jsx("tr",{children:S(w.length+1).map(n=>{let t="",r=h.cell;if(i===0&&n>0)t=w[n-1];else if(n===0&&i>0)t=e.jsxs(e.Fragment,{children:[m[i-1],m[i-1]!=="≤2 regular committers"&&e.jsx("div",{style:h.subtext,children:"≥3 regular committers"})]}),r={...r,whiteSpace:"nowrap",textAlign:"left"};else if(i>0&&n>0){const p=m[i-1];if(g.includes(p))t=e.jsx("b",{children:"Free"});else{const a=i-g.length-1;if(a>=0&&a<b.length){const l=b[a][n-1];t=e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:h.priceContainer,children:[e.jsx("b",{children:l}),e.jsx("span",{style:h.priceSubtext,children:"/ month"})]}),e.jsx("div",{style:h.recommendation,children:"Recommendation"})]})}}}return e.jsx("td",{style:r,children:t},n)})},i))})})}function S(i){return Array.from({length:i},(n,t)=>t)}const q=[{pageSectionId:"pricing",pageSectionLevel:4,pageSectionTitle:"Pricing"},{pageSectionId:"open-source-pricing",pageSectionLevel:4,pageSectionTitle:"Open Source Pricing"},{pageSectionId:"who-pays-and-how-much",pageSectionLevel:2,pageSectionTitle:"Who pays and how much?"},{pageSectionId:"free-tier",pageSectionLevel:3,pageSectionTitle:"Free tier"},{pageSectionId:"recommendation",pageSectionLevel:3,pageSectionTitle:"Recommendation"},{pageSectionId:"do-sponsors-have-to-pay",pageSectionLevel:2,pageSectionTitle:"Do sponsors have to pay?"},{pageSectionId:"how-does-it-apply-to-monorepos",pageSectionLevel:2,pageSectionTitle:"How does it apply to monorepos?"},{pageSectionId:"how-does-it-work",pageSectionLevel:2,pageSectionTitle:"How does it work?"},{pageSectionId:"why-zero-investors",pageSectionLevel:2,pageSectionTitle:"Why zero-investors?"},{pageSectionId:"is-vike-still-free-software",pageSectionLevel:2,pageSectionTitle:"Is Vike still Free Software?"},{pageSectionId:"why-not-another-business-model",pageSectionLevel:2,pageSectionTitle:"Why not another business model?"}];function k(i){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(L,{children:"The Open Source Pricing isn't implemented yet."}),`
`,e.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:37,marginBottom:30},children:e.jsx("img",{src:O,style:{maxWidth:"100%"}})}),`
...
`,e.jsx(o,{doNotInferSectionTitle:!0,href:"#who-pays-and-how-much"}),`
`,e.jsx("br",{}),`
`,e.jsx(o,{doNotInferSectionTitle:!0,href:"#do-sponsors-have-to-pay"}),`
`,e.jsx("br",{}),`
`,e.jsx(o,{doNotInferSectionTitle:!0,href:"#how-does-it-apply-to-monorepos"}),`
`,e.jsx("br",{}),`
...
`,e.jsx(W,{}),`
`,e.jsx("br",{}),`
`,e.jsx(o,{href:"#free-tier"}),`
`,e.jsx("br",{}),`
`,e.jsx(o,{href:"#recommendation"}),`
`,e.jsx("br",{}),`
...
`]}),`
`,e.jsxs(n.p,{children:["If you are within the free tier then ",e.jsx(n.strong,{children:"you don't need any license key"}),": you can use Vike just like any other open source tool. See also ",e.jsx(o,{href:"#how-does-it-work"})]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["See also: ",e.jsx(o,{href:"/build-your-own-framework"}),"."]}),`
`]}),`
