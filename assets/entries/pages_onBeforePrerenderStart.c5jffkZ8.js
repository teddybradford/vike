import{j as e,b as r,L as o,o as t}from"../chunks/chunk-BXtnpaDZ.js";import{L as l}from"../chunks/chunk-DsghOZ12.js";/* empty css                      *//* empty css                      *//* empty css                      */import{H as i}from"../chunks/chunk-DD4Kyn9V.js";/* empty css                      */import{M as d}from"../chunks/chunk-C-f040xX.js";/* empty css                      *//* empty css                      */import"../chunks/chunk-u42NeO_H.js";/* empty css                      */const c=[{pageSectionId:"for-providing-urls",pageSectionLevel:2,pageSectionTitle:"For providing URLs"},{pageSectionId:"for-bulk-data-fetching",pageSectionLevel:2,pageSectionTitle:"For bulk data fetching"},{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(s){const n={blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onBeforePrerenderStart()"})," hook is executed upon ",e.jsx(l,{text:"pre-rendering",href:"/pre-rendering"})," your app."]}),`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onBeforePrerenderStart()"})," hooks are called when you run ",e.jsx("code",{children:"$ vite build"})," and, consequently, are never called in development."]}),`
`]}),`
`,e.jsx("h2",{id:"for-bulk-data-fetching",children:"For bulk data fetching"}),`
`,e.jsxs(n.p,{children:["If you have a high number of pages that are to be pre-rendered, then running the command ",e.jsx("code",{children:"$ vite build"})," may become slow."]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  // ..."})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx(i,{hookTypeName:"OnBeforePrerenderStartAsync"}),`
