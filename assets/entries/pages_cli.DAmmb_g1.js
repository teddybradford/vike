import{j as e,L as s,o,i as l}from"../chunks/chunk-CUJVd1ox.js";import{L as r}from"../chunks/chunk-Cm3UaQpR.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DMg5Rc46.js";/* empty css                      */const a=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(i){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Usage:"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"$ vike prerender"})," ",e.jsx(r,{href:"/pre-rendering",children:"Pre-render"})," pages."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"$ vike -v"})," Print Vike's installed version."]}),`
`]}),`
`,e.jsx(n.p,{children:"Vike's CLI doesn't have any options, instead:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["change your ",e.jsx(n.code,{children:"vite.config.js"})," file, or"]}),`
`,e.jsxs(n.li,{children:["use the ",e.jsx(n.code,{children:"VITE_CONFIG"})," environment variable."]}),`
`]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"# When running Vike's CLI over a package.json script"})}),`
...
`,e.jsxs(n.p,{children:["You can define ",e.jsx(n.code,{children:"VITE_CONFIG"})," using JavaScript-like syntax, ",e.jsx(n.a,{href:"https://json.org/example.html",children:"JSON syntax"}),", or ",e.jsx(n.a,{href:"https://json5.org/#example",children:"JSON5 syntax"}),". (Vike uses ",e.jsx(n.a,{href:"https://json5.org",children:"JSON5"})," to parse ",e.jsx(n.code,{children:"VITE_CONFIG"}),".)"]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["We believe ",e.jsx(n.code,{children:"vite.config.js"})," with ",e.jsx(n.code,{children:"VITE_CONFIG"})," offers better DX than CLI options. Feel free to start a discussion if you have a use case where CLI options work better."]}),`
`]}),`
