import{j as e,o as r,i as o}from"../chunks/chunk-KSltIhmt.js";import{L as n}from"../chunks/chunk-DPhxMA0u.js";/* empty css                      */import{U as a}from"../chunks/chunk-ScrxolXu.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B0bomZhE.js";/* empty css                      */const i=[{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(l){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Environment: server, client.",e.jsx(s.br,{}),`
`,"Implemented by: ",e.jsx(a,{})," (or ",e.jsx(n,{href:"#without-vike-react-vue-solid",children:"yourself"}),")."]}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["You can also access the data over ",e.jsx(n,{href:"/pageContext#:~:text=pageContext.data,-%3A",children:e.jsx(s.code,{children:"pageContext.data"})}),". In fact ",e.jsx(n,{href:"/usePageContext",children:e.jsx(s.code,{children:"const { data } = usePageContext()"})})," returns the same value as ",e.jsx(s.code,{children:"useData()"}),"."]}),`
...
`,e.jsxs(s.p,{children:["In case you don't use a ",e.jsx(a,{}),", you can implement ",e.jsx(s.code,{children:"useData()"})," yourself."]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-react/renderer/useData.js"})," (React + JavaScript)"]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-react-ts/renderer/useData.ts"})," (React + TypeScript)"]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-vue/renderer/useData.js"})," (Vue + JavaScript)"]}),`
`,e.jsxs(s.li,{children:[e.jsx(n,{href:"/boilerplates/boilerplate-vue-ts/renderer/useData.ts"})," (Vue + TypeScript)"]}),`
...
`]}),`
`]})]})}function c(l={}){const{wrapper:s}=l.components||{};return s?e.jsx(s,{...l,children:e.jsx(t,{...l})}):t(l)}const d=Object.freeze(Object.defineProperty({__proto__:null,default:c,pageSectionsExport:i},Symbol.toStringTag,{value:"Module"})),v={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:r}},NavHeader:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/+NavHeader.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:o}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/useData/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:d}}};export{v as configValuesSerialized};
