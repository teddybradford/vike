import{j as e,b as r,i as a,L as o,o as l}from"../chunks/chunk-D87NQbdk.js";import{L as n}from"../chunks/chunk-OzoxVDhD.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BI6e2m4i.js";import{U as c}from"../chunks/chunk-DzUoto1W.js";import{E as d}from"../chunks/chunk-D3_Om_Xz.js";/* empty css                      */import{C as h}from"../chunks/chunk-Dzet5Zgk.js";/* empty css                      */import"../chunks/chunk-Cr11lVy5.js";import"../chunks/chunk-BuPOxs1B.js";import"../chunks/chunk-LZd1X6uG.js";const p=[{pageSectionId:"vike-react",pageSectionLevel:2,pageSectionTitle:"`vike-react`"},{pageSectionId:"custom-integration",pageSectionLevel:2,pageSectionTitle:"Custom integration"},{pageSectionId:"react-server-components",pageSectionLevel:2,pageSectionTitle:"React Server Components"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function s(i){const t={a:"a",blockquote:"blockquote",code:"code",li:"li",p:"p",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx("h2",{id:"vike-react",children:e.jsx("code",{children:"vike-react"})}),`
...
`,e.jsx(h,{list:["vike-react"]}),`
`,e.jsx(t.p,{children:"Official examples:"}),`
`,e.jsxs(t.ul,{children:[`
`,e.jsxs(t.li,{children:[e.jsx(r,{path:"/boilerplates/boilerplate-react-ts"})," - Classic integration, using ",e.jsx(n,{href:"/client-routing",children:"Client Routing"}),"."]}),`
`,e.jsxs(t.li,{children:[e.jsx(r,{path:"/examples/react-minimal"})," - Minimalistic integration, using ",e.jsx(n,{href:"/server-routing",children:"Server Routing"}),"."]}),`
...
`,e.jsxs(t.li,{children:[e.jsx(r,{path:"/examples/render-modes"})," - Integration supporting all ",e.jsx(n,{href:"/render-modes",children:"render modes"})," (SSR, SPA, and HTML-only)."]}),`
`]}),`
`,e.jsxs(t.blockquote,{children:[`
