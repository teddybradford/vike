import{j as e,L as a,o as r,i as t}from"../chunks/chunk-CUJVd1ox.js";import{L as n}from"../chunks/chunk-Cm3UaQpR.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DMg5Rc46.js";/* empty css                      */const o=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Using the Vite CLI is deprecated starting from ",e.jsx(s.code,{children:"vike@0.4.213"}),"."]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsx(s.p,{children:"You can still use it, but you'll see following warning and support for Vite's CLI will be completely removed in the next major release."}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`1:18:05 PM [vike][Warning] The Vite CLI is deprecated
`})}),`
`]}),`
`,e.jsx(s.p,{children:"Use the Vike CLI instead:"}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["The Vike CLI is a major milestone towards the ",e.jsx(s.code,{children:"1.0"})," release and unlocks new fundamental capabilities."]}),`
`]}),`
`,e.jsxs(s.p,{children:["Vike's CLI doesn't have any option: use the ",e.jsx(s.code,{children:"VITE_CONFIG"})," environment variable instead, see ",e.jsx(n,{href:"/cli"}),"."]}),`
`,e.jsxs(s.p,{children:["We also recommend using ",e.jsx(n,{href:"/api",children:"Vike's JavaScript API"})," instead of ",e.jsx(s.a,{href:"https://vite.dev/guide/api-javascript",children:"Vite's JavaScript API"}),", as some features in the near future will only be available when using Vike's JavaScript API."]}),`
