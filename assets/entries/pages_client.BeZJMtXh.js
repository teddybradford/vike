import{j as e,b as r,o as l,i as o}from"../chunks/chunk-KSltIhmt.js";import{L as i}from"../chunks/chunk-DPhxMA0u.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-B0bomZhE.js";/* empty css                      */const a=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function s(t){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["You can define a ",e.jsx(n.code,{children:"+client.js"})," file to add client-side JavaScript."]}),`
`,e.jsxs(n.p,{children:["It's usually used for initializing ",e.jsx(i,{href:"/errors",children:"error tracking"}),", user tracking, cookie consent, CSS frameworks, etc."]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(r,{path:"/examples/render-modes/pages/html-js/+client.js"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
