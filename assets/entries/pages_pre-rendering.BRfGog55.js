import{j as e,b as s,L as a,o,i as l}from"../chunks/chunk-CcNCPWf0.js";import{L as n}from"../chunks/chunk-DnqpiJIa.js";/* empty css                      *//* empty css                      *//* empty css                      */import{M as d}from"../chunks/chunk-YN_XUv3M.js";/* empty css                      *//* empty css                      */import"../chunks/chunk-CR_7OJhJ.js";/* empty css                      */const c=[{pageSectionId:"what-is-pre-rendering",pageSectionLevel:2,pageSectionTitle:"What is pre-rendering?"},{pageSectionId:"should-i-pre-render",pageSectionLevel:2,pageSectionTitle:"Should I pre-render?"},{pageSectionId:"how-to-pre-render",pageSectionLevel:2,pageSectionTitle:"How to pre-render"},{pageSectionId:"ssg-vs-ssr",pageSectionLevel:2,pageSectionTitle:"SSG vs SSR"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(t){const r={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx("h2",{id:"what-is-pre-rendering",children:"What is pre-rendering?"}),`
`,e.jsxs(r.p,{children:["Pre-rendering means to render the HTML of pages at build-time (when running ",e.jsx(r.code,{children:"$ vite build"}),")."]}),`
...
`,e.jsx(r.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(r.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(r.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(r.span,{"data-line":"",children:e.jsx(r.span,{style:{color:"#6A737D"},children:"// vite.config.js"})}),`
`,e.jsx(r.span,{"data-line":"",children:" "}),`
`,e.jsxs(r.span,{"data-line":"",children:[e.jsx(r.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(r.span,{style:{color:"#24292E"},children:" vike "}),e.jsx(r.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(r.span,{style:{color:"#032F62"},children:" 'vike/plugin'"})]}),`
`,e.jsx(r.span,{"data-line":"",children:" "}),`
...
`,e.jsx(r.span,{"data-line":"",children:e.jsx(r.span,{style:{color:"#24292E"},children:"  plugins: ["})}),`
`,e.jsxs(r.span,{"data-line":"",children:[e.jsx(r.span,{style:{color:"#6F42C1"},children:"    vike"}),e.jsx(r.span,{style:{color:"#24292E"},children:"({ prerender: "}),e.jsx(r.span,{style:{color:"#005CC5"},children:"true"}),e.jsx(r.span,{style:{color:"#24292E"},children:" })"})]}),`
...
`,e.jsxs(r.p,{children:["Your pages' HTML will be rendered when you run ",e.jsx(r.code,{children:"$ vite build"})," and the generated HTML files are available at ",e.jsx(r.code,{children:"dist/client/"}),"."]}),`
...
`,e.jsxs(r.p,{children:["If you pre-render all your pages, then you can use Vite's CLI instead of a server (",e.jsx(r.code,{children:"$ vite dev"})," and ",e.jsx(r.code,{children:"$ vite preview"}),"). See linked examples below."]}),`
...
`,e.jsx(s,{path:"/examples/react-full/pages/hello/+onBeforePrerenderStart.ts"}),`
`]}),`
`,e.jsxs(r.li,{children:[`
`,e.jsx(s,{path:"/examples/react-full/pages/star-wars/index/+onBeforePrerenderStart.ts"}),`
`]}),`
`,e.jsxs(r.li,{children:[e.jsx(s,{path:"/examples/react-full/package.json"})," (see Vite CLI usage)"]}),`
`]}),`
`,e.jsx(r.p,{children:"Vue Example:"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsxs(r.li,{children:[e.jsx(s,{path:"/examples/vue-full/vite.config.ts"})," (see setting ",e.jsx("code",{children:"prerender"})," option to ",e.jsx(r.code,{children:"true"}),")"]}),`
`,e.jsxs(r.li,{children:[`
`,e.jsx(s,{path:"/examples/vue-full/pages/hello/+onBeforePrerenderStart.ts"}),`
`]}),`
`,e.jsxs(r.li,{children:[`
`,e.jsx(s,{path:"/examples/vue-full/pages/star-wars/index/+onBeforePrerenderStart.ts"}),`
`]}),`
`,e.jsxs(r.li,{children:[e.jsx(s,{path:"/examples/vue-full/package.json"})," (see Vite CLI usage)"]}),`
`]}),`
...
`,e.jsxs(r.ul,{children:[`
`,e.jsxs(r.li,{children:["SSG: the HTML of pages is rendered at build-time (when calling ",e.jsx(r.code,{children:"$ vite build"}),")"]}),`
...
`,e.jsx(r.p,{children:"Related docs:"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsxs(r.li,{children:[`
