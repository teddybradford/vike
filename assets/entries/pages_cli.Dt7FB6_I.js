...
`,e.jsxs(n.p,{children:["You can pass ",e.jsx(s,{href:"/settings",children:"Vike settings"})," as CLI options, for example:"]}),`
...
`,e.jsx("h4",{id:"cli-options",children:"CLI options"}),`
`,e.jsxs(n.p,{children:["As explained ",e.jsx(s,{href:"#vike-settings",children:"above"}),", the following ",e.jsx(n.a,{href:"https://vite.dev/guide/cli",children:"Vite CLI options"})," are supported: ",e.jsx(n.code,{children:"--host"})," / ",e.jsx(n.code,{children:"--mode"})," / ",e.jsx(n.code,{children:"--port"}),"."]}),`
`,e.jsxs("h4",{id:"vite-config-environment-variable",children:[e.jsx("code",{children:"VITE_CONFIG"})," environment variable"]}),`
